...
| ---------- | --- | --- | --- | --- | ------ | ----------- | --------- | ------ | ---------- | ------------ | ------------- | --- |
| processing |     |     |     |     |        |             |           |        | brain’s    |              |               |     |
|            |     |     |     |     | In     | particular, | one       | of the | key        | tricks,      | it now seems, |     |
“The
whole function of the brain is summed up in: error is to implement dumb processes that correct a certain
correction.”
So wrote W. Ross Ashby, the British psychia- kind of error: error in the multi-layered prediction of
...
Ashby’s
(admittedly somewhat vague) statement is to lower-level ones on the basis of their own emerging
...
“fantasy,”
modelsofthecausalstructureoftheworld(i.e.,thesignal to create the sensory patterns for itself (in as it
said).3
source). Errors in predicting lower level inputs cause the was sometimes (For a useful review of this crucial
...
responsesaregeneratedbyaninteractingwebofcauses–
| sensory systems | are in | the tricky | business | of  | inferring |     |     |     |     |     |     |
| --------------- | ------ | ---------- | -------- | --- | --------- | --- | --- | --- | --- | --- | --- |
...
Helmholz’sinsightinformedinfluentialworkbyMacKay
(asweshallshortlyseeinmoredetail)interactingcausesin
...
twist–the
world is) simply by accumulating, from the bottom-up, a It is this strategy of using top-down connec-
...
|     |     |     |     |     |     |     | cascade–that |     |     |     | “hierarchical |
| --- | --- | --- | --- | --- | --- | --- | ------------ | --- | --- | --- | ------------- |
current suite of cues from its best models of the possible multilevel lies at the heart of
coding”
causes. In this way: predictive approaches to perception; for
|     |     |     |     |     |     | example, | Rao and Ballard |     | (1999), | Lee | and Mumford |
| --- | --- | --- | --- | --- | --- | -------- | --------------- | --- | ------- | --- | ----------- |
Themappingfromlow-tohigh-levelrepresentation(e.g.from (2003), Friston (2005). Such approaches, along with
...
| 2006,p.340,theiremphasis) |              |                 |         |     |           |                 |             |         | (2011)–form |     |                |
|                           |              |                 |         |     |           | Friston (2010), | Brown       | et      | al.         |     | the main       |
Helmholz’s
insight was also pursued in an important focus of the present treatment. These approaches
...
influence
that began with pioneering connectionist work on back- might operate. That way (borrowing from
coding–see
propagation learning (McClelland et al. 1986; Rumelhart work in linear predictive below) depicts the
flow
et al. 1986) and continued with work on the aptly named top-down as attempting to predict and fully
...
system–see
holtz Machine sought to learn new representations in a forward within the Rao and Ballard (1999),
...
| --------------- | ---------------- | --- | -------- | ---------- | ---- | ----------- | --- | --- | --- | --- | --- |
Predictivecodingitselfwasfirstdevelopedasadatacom-
| Hinton 2010) | upon standard |     | back-propagation |     | driven |     |     |     |     |     |     |
| ------------ | ------------- | --- | ---------------- | --- | ------ | --- | --- | --- | --- | --- | --- |
...
| Sciences | at the University | of  | Edinburgh | in Scotland. |     |           |          |                |     |              |          |
| -------- | ----------------- | --- | --------- | ------------ | --- | --------- | -------- | -------------- | --- | ------------ | -------- |
|          |                   |     |           |              |     | one. What | needs to | be transmitted |     | is therefore | just the |
He is the author of six monographs, including Being “prediction error”)
|     |     |     |     |     |     | difference | (a.k.a. the |     |     |     | between the |
| --- | --- | --- | --- | --- | --- | ---------- | ----------- | --- | --- | --- | ----------- |
There:PuttingBrain,BodyandWorldTogetherAgain
|               |              |          |              |            |     | actual current | signal        | and the         | predicted  | one. | This affords   |
| ------------- | ------------ | -------- | ------------ | ---------- | --- | -------------- | ------------- | --------------- | ---------- | ---- | -------------- |
...
University Press, 2003), and Supersizing the Mind: by James Flanagan and others at Bell Labs during the
Embodiment,Action, andCognitiveExtension(Oxford 1950s (for a review, see Musmann 1979). Descendents of
...
|     |     |     |     |     |     |     |     |     |     |     | al.’s |     |     |     | “news- |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | ------ |
higher-levelestimatesoftheinputsignal.(Rao&Ballard1999, what is (to use Hosoya et own phrase) most
|     |       |     |     |     |     |     |     | worthy” |                |     | signal.10 |     |     |     |     |
| --- | ----- | --- | --- | --- | --- | --- | --- | ------- | -------------- | --- | --------- | --- | --- | --- | --- |
|     | p.80) |     |     |     |     |     |     |         | in theincoming |     |           |     |     |     |     |
...
fromV1toV2wouldcarryforwardtheerrorsignal9indicat-
logicallyrealisticsituations.Totakesomeofthemoredra-
...
five
from natural scenes. Using learning algorithms that similar in image intensity vary markedly between such
...
efficient,
and bars, while the second level network came to interests of adaptively potent, encoding, the be-
havioroftheretinalganglioncells(specifically,theirrecep-
| capture |     | combinations | of such | features | corresponding |     | to  |     |     |     |     |     |     |     |     |
| ------- | --- | ------------ | ------- | -------- | ------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
configurations. tivefieldproperties)shouldvaryasaresultofadaptationto
| patterns |     | involving | larger | spatial |     |     | The |     |     |     |     |     |     |     |     |
| -------- | --- | --------- | ------ | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
we’ll
such non-classical surround effects (and, as later Putting salamanders and rabbits into varying environ-
see, context effects more generally) may be a rather ments, and recording from their retinal ganglion cells,
confirmed
direct consequence of the use of hierarchical predictive Hosoya et al. their hypothesis: Within a space
...
|     |     |     |     |     |     |     |     | “novelty | filters” |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | -------- | --- | --- | --- | --- | --- | --- |
better predictions concerning what to expect next, in of that learn to become insensitive to the
“familiar”)
space or in time. The cascade of processing induced by most highly correlated (hence most features of
...
1.3. Dynamicpredictivecodingbytheretina
|     |     |     |     |     |     |     |     | retinal ganglion |                       | cells seem | to  | be engaging | in  | a computa- |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------------- | --------------------- | ---------- | --- | ----------- | --- | ---------- | --- |
|     |     |     |     |     |     |     |     | tionally         | and neurobiologically |            |     | explicable  |     | process    | of  |
Asanexampleofthepower(andpotentialubiquity)ofthe
|       |            |     |                 |         |     |          |       | dynamic | predictive | recoding |     | of raw | image inputs, |     | whose |
| ----- | ---------- | --- | --------------- | ------- | --- | -------- | ----- | ------- | ---------- | -------- | --- | ------ | ------------- | --- | ----- |
| basic | predictive |     | coding strategy | itself, | and | one that | now   |         |            |          |     |        |               |     |       |
|       |            |     |                 |         |     |          | al.’s |         | “strip     |          |     |        |               |     |       |
moves context center stage, consider Hosoya et effect is to from the visual stream predictable and
signals”
(2005) account of dynamic predictive coding by the therefore less newsworthy (Hosoya et al. 2005,
...
| fields  |         |                 |               |              |             |                 |         | 1.4. Anotherillustration:Binocularrivalry |     |     |     |     |     |     |     |
|         | display | center-surround |               | spatial      | antagonism, |                 | as well |                                           |     |     |     |     |     |     |     |
...
al.’s
local image characteristics, the likely image characteristics consider Hohwy et (2008) hierarchical predictive
...
“Ganglion
cells signal not the raw visual image but the with a different visual stimulus. Thus, the right eye might
...
Andy Clark: Predictive brains, situated agents, and thefuture ofcognitivescience
free-energy”
will change to minimize (Friston & Stephan interacting set of distal causes that predict, accommodate,
“explain away”the
2007, p. 427). Notice that, thus formulated, this is a claim and (thus) driving sensory signal.
|     |     |     |     |     |     |     |     |     |     | “explaining |     | away” |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----------- | --- | ----- | --- | --- | --- |
aboutallelementsofsystemicorganization(fromgrossmor- This appeal to is important and
...
efficient
of neural functioning, leads to the generation of early sensory case) merely react to external stimuli. It is
...
representsakindof“maximalversion”oftheclaimsscouted
|     |     |     |     |     |     |     |     | potentially | misleading |     | tosay | that: |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------- | ---------- | --- | ----- | ----- | --- | --- | --- |
insection1.5concerningthecomputationalintimacyofper-
|     |     |     |     |     |     |     |     | Activation | in early | sensory | areas | no longer | represents |     | sensory |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | -------- | ------- | ----- | --------- | ---------- | --- | ------- |
ceptionandaction,anditissuggestiveofageneralframework
|            |             |     |             |     |          |       |       | information         | per | se, but | only        | that part    | of the | input that     | has |
| ---------- | ----------- | --- | ----------- | --- | -------- | ----- | ----- | ------------------- | --- | ------- | ----------- | ------------ | ------ | -------------- | --- |
| that might | accommodate |     | the growing |     | interest | (see, | e.g., |                     |     |         |             |              |        |                |     |
|            |             |     |             |     |          |       |       | notbeensuccessfully |     |         | predictedby | higher-level |        | areas. (de-Wit |     |
...
Friston 2009, p. 293). A full assessment of the free energy considering17)
|           |              |     |            |           |     |             |     | models    | we have | been          |     |          | actually | depicted | as   |
| --------- | ------------ | --- | ---------- | --------- | --- | ----------- | --- | --------- | ------- | ------------- | --- | -------- | -------- | -------- | ---- |
| principle | is, however, |     | far beyond | the scope | of  | the present |     |           |         |               |     |          |          |          |      |
|           |              |     |            |           |     |             |     | a kind of | duplex  | architecture: |     | one that | at each  | level    | com- |
treatment.15
In the remainder of this article, I turn instead bines quite traditional representations of inputs with rep-
...
tionandtheirpossibleextensionstoaction.
|     |     |     |     |     |     |     |     | signal, which | (in | these | models) | is depicted |     | as computed |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ------------- | --- | ----- | ------- | ----------- | --- | ----------- | --- |
bydedicated“errorunits.”Thesearelinkedto,butdistinct
|     |     |     |     |     |     |     |     | from, the | so-called | representation |     | units | meant | to encode |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | --------- | -------------- | --- | ----- | ----- | --------- | --- |
2. Representation,inference, and the continuity of thecausesofsensory inputs. By cancelling outthe activity
perception, cognition, and action oftheerrorunits,activityinsomeofthelaterallyinteract-
“representation”
|                  |     |            |            |     |          |       |      | ing |     |     | units | (which then | feed | predictions |     |
| ---------------- | --- | ---------- | ---------- | --- | -------- | ----- | ---- | --- | --- | --- | ----- | ----------- | ---- | ----------- | --- |
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | --- | ------------ | --- | ---------- | ---------- | ------- | --- |
viouswaysofthinkingaboutperception,cognition,andthe
|     |     |     |     |     |     |     |     | thus avoids | any | direct | conflict | with accounts |     | (e.g., biased- |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------- | --- | ------ | -------- | ------------- | --- | -------------- | --- |
...
|     |     |     |     |     |     |     |     |           |       | “shut | up” |               |          |     |        |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | ----- | ----- | --- | ------------- | -------- | --- | ------ |
|     |     |     |     |     |     |     |     | the error | units | to    |     | [while] units | encoding | the | causes |
...
| ------ | ------------ | ------- | --------- | --- | --------------- | --- | --- | ------- | --------- | --- | ---------- | ------- | --- | -------------- | --- |
|        |              |         |           |     |                 |     |     | and the | dampening | of  | (different | aspects | of) | early cortical |     |
...
|     |     |     |     |     |     |     |     | the strong | emphasis |     | the predictive | coding | hypothesis |     | places |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | -------- | --- | -------------- | ------ | ---------- | --- | ------ |
body)andtheuncertaintiesassociatedwithitsownproces-
“theory-laden” on the error-detecting nodes and the corresponding under-
| sing. Perception |     | here | becomes |     |     | in at | least |     |     |     |     |     |     |     |     |
| ---------------- | --- | ---- | ------- | --- | --- | ----- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
specific) emphasis on the role of the prediction nodes in maintaining
| one (rather |     |     | sense: What | we  | perceive | depends |     |           |                |     |     |               |            |     |        |
| ----------- | --- | --- | ----------- | --- | -------- | ------- | --- | --------- | -------------- | --- | --- | ------------- | ---------- | --- | ------ |
...
flow
stack of states of a generative model (recall sect. 1.1 really occurs) is that it depicts the forward of infor-
...
|     |     |     |     |     |     | “CAT | MAT,” |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | ---- | ----- | --- | --- | --- | --- | --- |
thusachievesaratherdelicatebalancebetweenthefamiliar senting ON the probabilistic Bayesian brain
...
|     | flow |     |     |     |     |     |     | influences |     |     |     |     |
| --- | ---- | --- | --- | --- | --- | --- | --- | ---------- | --- | --- | --- | --- |
forward of sensory information is now entirely the bottom-up driving from multiple sensory
|     |     | flow |     |     |     |     |     |     | context-fixing |     |     |     |
| --- | --- | ---- | --- | --- | --- | --- | --- | --- | -------------- | --- | --- | --- |
replaced by a forward ofpredictionerror). channels and top-down information of
...
|     |     |     | “two |     |     | initialflurry |     |     |     |     |     |     |
| --- | --- | --- | ---- | --- | --- | ------------- | --- | --- | --- | --- | --- | --- |
by positing the existence of functionally distinct sub- of error signals (which are said to constitute a
populations, encoding the conditional expectations of per- major component of early evoked responses; see, e.g.,
|     |     |     |     |     | respectively” |     |     |     |     | “beliefs” |     |     |
| --- | --- | --- | --- | --- | ------------- | --- | --- | --- | --- | --------- | --- | --- |
ceptual causes and the prediction error Friston 2005, p. 829) as competing propagate up
...
superficial
conjecture in this literature depicts pyramidal further details (STRIPEY MAT, TABBY CAT) sub-
cells(aprimesourceofforwardneuro-anatomicalconnec- sequently negotiated. The set-up thus favors a kind of
“gist-at-a-glance”
tions) as playing the role of error units, passing prediction recurrently negotiated model, where we
...
|     |     |     |     |     |     |     | “forest first, |     | second” |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------------- | --- | ------- | --- | --- | --- |
e.g., Friston 2005; 2009; Mumford 1992). However it a kind of trees approach (Friston
...
|     |     |     |     |     |     | “turned   | on”             |      |          |           |            |          |
| --- | --- | --- | --- | --- | --- | --------- | --------------- | ---- | -------- | --------- | ---------- | -------- |
|     |     |     |     |     |     | denly     | and             | some | random   | or        | unexpected | input    |
...
| ---------- | ---------------- | ----- | -------- | ---------------- | ----------- | ------------ | ------------- | --------- | ------------ | ------ | ---------- | --------- |
| Neural     | representations, |       | should   | the hierarchical | predictive  |              |               |           |              |        |            |           |
|            |                  |       |          |                  |             | cases where  | we, by        | our       | own actions, |        | help to    | bring the |
| processing | account          | prove | correct, | encode           | probability |              |               |           |              |        |            |           |
|            |                  |       |          |                  |             | new stimulus | about.        | In the    | event        | that   | we already | know      |
densitydistributions20intheformofaprobabilisticgenera-
|     |     |     |     |     |     | we are | in a forest | (perhaps | we  | have | been hiking | for |
| --- | --- | --- | --- | --- | --- | ------ | ----------- | -------- | --- | ---- | ----------- | --- |
flow
tive model, and the of inference respects Bayesian hours), there has still been prior settling into a higher
principles that balance prior expectations against new level representational state. But such settling need not
| sensory                                                | evidence. | This | (Eliasmith | 2007) | is a departure |              |          |          |      |             |         |     |
| ------------------------------------------------------ | --------- | ---- | ---------- | ----- | -------------- | ------------ | -------- | -------- | ---- | ----------- | ------- | --- |
|                                                        |           |      |            |       |                | occur within | the      | temporal | span | following   | each    | new |
| fromtraditionalunderstandingsofinternalrepresentation, |           |      |            |       |                |              | input.22 |          |      |             |         |     |
|                                                        |           |      |            |       |                | sensory      | Over     | whatever |      | time-scale, | though, | the |
...
requiressome(perhapsseveral)concretemeansofintern-
|                   |     |              |                |     |              | of the scene           | (from the | general | theme | all         | the way | down to |
| ----------------- | --- | ------------ | -------------- | --- | ------------ | ---------------------- | --------- | ------- | ----- | ----------- | ------- | ------- |
| ally representing |     | uncertainty. | (Non-exclusive |     | options here |                        |           |         |       |             |         |         |
|                   |     |              |                |     |              | more spatio-temporally |           | precise |       | information | about   | parts,  |
...
| --- | --- | --- | --- | --- | --- | ------- | -------------- | ---- | ------ | ---------- | ----------- | --- |
2008)–for
relative timing effects (Deneve a very useful tic, encoding a series of intertwined bets concerning all
review,seeVilares&Körding2011).Predictiveprocessing
|          |            |      |       |            |                | the elements | (at the      | various | spatio-temporal |     | scales) | that |
| -------- | ---------- | ---- | ----- | ---------- | -------------- | ------------ | ------------ | ------- | --------------- | --- | ------- | ---- |
| accounts | thus share | what | Knill | and Pouget | (2004, p. 713) |              |              |         |                 |     |         |      |
|          |            |      |       |            |                | makeup       | theperceived | scene.  |                 |     |         |      |
the“basicpremise
describe as on which Bayesian theories In what sense are such systemstruly Bayesian? Accord-
succeedorfail,”
ofcortical processing will namely,that: ingtoKnilland Pouget:
...
encodes“therelativeprobabilitythattheobjectisatdiffer-
|     |     |     |     |     |     | information | it actually | manages |     | to encode | and | process, |
| --- | --- | --- | --- | --- | --- | ----------- | ----------- | ------- | --- | --------- | --- | -------- |
information”
ent depths Z, given the available sensory and (I would add) the general shape of the strategies it
...
| --- | --- | ------- | --- | --------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
independent) correlates of Thus, varied according to how reliable (how noisy, certain, or
...
EEG)signaturesofconsciousperceptionvaryaccordingly–
|     |     |     |     |     |     |     | surprising | things, | at least | in  | conditions | where | the | brain |
| --- | --- | --- | --- | --- | --- | --- | ---------- | ------- | -------- | --- | ---------- | ----- | --- | ----- |
...
learning.”
| expectation | factors, | where | the differentiation |     | between | FFA | perception | and |     |     |     |     |     |     |
| ----------- | -------- | ----- | ------------------- | --- | ------- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- |
...
“cognitive”)
probes, suggesting that “[FFA] responses appear to be models26 intuitively correspond to increasingly
|            |     |         |             |     |          |        | abstract | conceptions |     | of the | world, | and these | tend | to  |
| ---------- | --- | ------- | ----------- | --- | -------- | ------ | -------- | ----------- | --- | ------ | ------ | --------- | ---- | --- |
| determined | by  | feature | expectation | and | surprise | rather |          |             |     |        |        |           |      |     |
se” capture or depend upon regularities at larger temporal and
| than by | stimulus | features | per | (Egner |     | et al. 2010, |     |     |     |     |     |     |     |     |
| ------- | -------- | -------- | --- | ------ | --- | ------------ | --- | --- | --- | --- | --- | --- | --- | --- |
...
specific
featuredetection)mightbebettertreatedasaface-expec- associated with kinds of perceptual contact. But it
|     |     |     |     |     |     |     | is the precision-modulated, |     |     |     | constant, | content-rich |     | inter- |
| --- | --- | --- | --- | --- | --- | --- | --------------------------- | --- | --- | --- | --------- | ------------ | --- | ------ |
tationregionratherthanasaface-detectionregion:aresult
|     |     |     |     |     |     |     | actions between |     | these | levels, | often | mediated | by ongoing |     |
| --- | --- | --- | --- | --- | --- | --- | --------------- | --- | ----- | ------- | ----- | -------- | ---------- | --- |
thattheauthorsinterpretasfavoringahierarchicalpredic-
...
| S e n s o r | y s t im u | la ti on m | ig ht b e th | e m in o | r ta s k o | f th e co r t e x , |     |     |     |     |     |     |     |     |
| ----------- | ---------- | ---------- | ------------ | -------- | ---------- | ------------------- | --- | --- | --- | --- | --- | --- | --- | --- |
implementingneuralmachinery,thesuperficiallycleandis-
| w h e r e a | s it s m | a jo r tas k | is to … p | red ic t u | pc o m in | g s ti mu la t i o n |     |     |     |     |     |     |     |     |
| ----------- | -------- | ------------ | --------- | ---------- | --------- | -------------------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| the basis | of previous | input | to the | system. | (Rauss | et al. 2011, |     |     |     |     |     |     |     |     |
| --------- | ----------- | ----- | ------ | ------- | ------ | ------------ | --- | --- | --- | --- | --- | --- | --- | --- |
atelevelofprocessing.Asthought,sensing,andmovement
| p.1249) |      |     |     |     |     |         |              |     |          |           |     | well-specified |     |        |
| ------- | ---- | --- | --- | --- | --- | ------- | ------------ | --- | -------- | --------- | --- | -------------- | --- | ------ |
|         |      |     |     |     |     |         | here unfold, | we  | discover | no stable | or  |                |     | inter- |
|         | fits |     |     |     |     | unified |              |     |          |           |     |                |     |        |
Attention very neatly into this emerging face or interfaces between cognition and perception.
...
“volume,”
achieved by altering the gain (the to use a we shall see in sect. 4.2) are mutually, reciprocally,
...
53–54]
precision (see Fletcher & Frith [2009, pp. who promise to bring cognition, perception, action, and atten-
...
reflected
means less uncertainty, and is in a higher gain on ing the world, and prediction-error minimization as the
...
field
increasedweight,hencebecomingmoreapttodrivelearning receptive effects, bi-stable perception, cue inte-
...
“real”
nation, of a wide variety ofsuch contextual effects. of units. One sub-population, recall, is doing the
find
Can we more direct forms of evidence as well? work of representing the current sensory cause: These
...
|     |     |     |     |     |     |     |     |     |     |     |     | area’s | “conditional |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ------ | ------------ | --- |
cessing (hierarchical predictive coding) story. As higher (2005, p. 829) describes as the expec-
causes.”
level areas settled into an interpretation of visual shape, tations of perceptual The other sub-population is
...
experiments.29
their Finally, the study by Egner et al. own level and at the level above, and the representation
...
|     | fit |     |     | best-fit |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | -------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
the best for their data. In that simulation, error Unfortunately, direct, unambiguous neural evidence for
(“face-surprise”)
units are modeled as contributing twice these crucial functionally distinct sub-populations is still
| asmuchtothefMRIsignalasrepresentation(“face-expec- |     |     |     |     |     |     |     | missing. | Hence: |     |     |     |     |     |
| -------------------------------------------------- | --- | --- | --- | --- | --- | --- | --- | -------- | ------ | --- | --- | --- | --- | --- |
tation”) units, leading the authors tocomment that: models–and
|     |     |     |     |     |     |     |     | One limitation |     | of these |     |     | of predictive | coding in |
| --- | --- | --- | --- | --- | --- | --- | --- | -------------- | --- | -------- | --- | --- | ------------- | --------- |
general–is
Thecurrentstudyistoourknowledgethefirstinvestigationto that to date no single neuron study has systemati-
callypursuedthesearchforsensorypredictionerrorresponses.
formally and explicitly demonstrate that population responses (Summerfield&Egner2009,p.408)
| in visual | cortex | are in | fact better | characterized |     | as  | a sum of |     |     |     |     |     |     |     |
| --------- | ------ | ------ | ----------- | ------------- | --- | --- | -------- | --- | --- | --- | --- | --- | --- | --- |
Thegoodnewsisthatthereis,aswesaw,mountingand
featureexpectationandsurpriseresponsesthanbybottom-up
...
TMS–transcranial stimulation–or (sect. 2.1) a plausible neuronal implementation for such a
| (e.g., using   |     |          |                 | magnetic |     |          |         |        |           |             |     |     |                |        |
| -------------- | --- | -------- | --------------- | -------- | --- | -------- | ------- | ------ | --------- | ----------- | --- | --- | -------------- | ------ |
|                |     |          |                 |          |     |          |         | scheme | involving | superficial |     | and | deep pyramidal | cells. |
| other methods) |     | with the | message-passing |          |     | routines | linking |        |           |             |     |     |                |        |
higher to lower cortical areas should impact performance. Nonetheless, much more evidence is clearly needed for
specific the existence of the clean functional separation (between
| To take                       | one       |             | example,       | the                       | model    | of binocular |       |              |          |           |           |     |          |              |
| ----------------------------- | --------- | ----------- | -------------- | ------------------------- | -------- | ------------ | ----- | ------------ | -------- | --------- | --------- | --- | -------- | ------------ |
...
| quite low | down | the processing |     | hierarchy. |     | The key | prin- |        |          |        |        |          |            |            |
| --------- | ---- | -------------- | --- | ---------- | --- | ------- | ----- | ------ | -------- | ------ | ------ | -------- | ---------- | ---------- |
|           |      |                |     |            |     |         |       | In the | ultimate | stable | state, | the deep | pyramidals | [conveying |
ciple–and
one that also explains many of the observed predictionsdownwards]wouldsendasignalthatperfectlypre-
responses–is
dynamics of evoked that (subject to the dictswhateachlowerareaissensing,uptoexpectedlevelsof
superficial
caveatsmentionedearlierconcerningalreadyactiveexpec- noise, and the pyramidals [conveying prediction
...
| profile |     |     | areas” |     |     |     |     |     |     |     |     |     |     |     |
| ------- | --- | --- | ------ | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
of neurons in lower (Friston 2003, p. 1348). In some sense, this is the state that the cortex is trying to
...
predictionsflowing
itsnormal context) by successful back- Thisremarkhighlightsaverygeneralworrythatissome-
...
Andy Clark: Predictivebrains,situated agents,and thefutureof cognitive science
| 4. Content | andconsciousness |     |     |     |     |     |     |                   |       |        |                  |         |           |
| ---------- | ---------------- | --- | --- | --- | --- | --- | --- | ----------------- | ----- | ------ | ---------------- | ------- | --------- |
|            |                  |     |     |     |     |     |     | alive. It         | would | do the | evolved creature | no good | at all to |
|            |                  |     |     |     |     |     |     | keep experiencing |       | the    | scene as to some | degree  | uncertain |
| finally,   |                  |     |     |     |     |     |     |                   |       |        | firm             |         |           |
How, do the accounts on offer relate to a human if the current task requires a decision, and if its
mentallife?This,ofcourse,isthehardest–thoughpoten-
|     |     |     |     |     |     |     |     | neural processing |     | has | already settled | on a good, | strongly |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------------- | --- | --- | --------------- | ---------- | -------- |
tiallythemostimportant–questionofall.Icannothopeto
|            |         |     |        |         |            |     |       | supported | bet | as towhat’s | (most probably) | out | there. |
| ---------- | ------- | --- | ------ | ------- | ---------- | --- | ----- | --------- | --- | ----------- | --------------- | --- | ------ |
| adequately | address | it  | in the | present | treatment, | but | a few |           |     |             |                 |     |        |
Onewaytobegintocashthatoutistorecallthatbiologi-
preliminaryremarksmayhelptostructureaspaceforsub-
|     |     |     |     |     |     |     |     | cal systems | will | be informed | by a variety | of  | learned or |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------- | ---- | ----------- | ------------ | --- | ---------- |
“hyperpriors”
sequent discussion. innate concerning the general nature of the
...
|                   |     |       |           |              |     |             |     | brain might36 |     | simply use | a form of probabilistic |     | represen- |
| ----------------- | --- | ----- | --------- | ------------ | --- | ----------- | --- | ------------- | --- | ---------- | ----------------------- | --- | --------- |
| that characterize |     | daily | conscious | thought      |     | and reason? | A   |               |     |            |                         |     |           |
| first             |     |       |           | superficial) |     |             |     |               |     |            |                         |     |           |
(but fortunately merely impression is that tation in which each distribution has a single peak
...
|          |              |     |            |           |     |            |     | such a | unimodal | probability | distribution. | Such | a prior |
| -------- | ------------ | --- | ---------- | --------- | --- | ---------- | --- | ------ | -------- | ----------- | ------------- | ---- | ------- |
| imagine, | for example, |     | the sudden | unveiling |     | of a large | and |        |          |             |               |      |         |
...
|            |     |         |       |        |              |     | sense– | Such | appeals | to powerful | (and often | quite | abstract) |
| ---------- | --- | ------- | ----- | ------ | ------------ | --- | ------ | ---- | ------- | ----------- | ---------- | ----- | --------- |
| improbable | but | not (at | least | not in | the relevant |     |        |      |         |             |            |       |           |
...
confidence such hyperpriors. Instead, they arise quite naturally
| degree | of  |     | in the | sensory | signal). | Given | the |     |     |     |     |     |     |
| ------ | --- | --- | ------ | ------- | -------- | ----- | --- | --- | --- | --- | --- | --- | --- |
...
|     |     |     |     |     |     |     |     | potency | of these | highly | abstract forms | of “systemic | expec- |
| --- | --- | --- | --- | --- | --- | --- | --- | ------- | -------- | ------ | -------------- | ------------ | ------ |
thedolefulelephantmaythenemergeastheleastsurpris-
|     | “surprisal-ing”!) |     |     |     |     |     |     | tation” |     |     |     |     |     |
| --- | ----------------- | --- | --- | --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- |
ing (least percept available, given the again raises questions about the eventual spread of
...
render that percept very likely in advance, hence investigationmayberequiredtofixandrevealthecontents
...
brain’s
clearly no inconsistency in thinking that the perva- hallucination in schizophrenia (Corlett et al. 2009a;
...
mandedanaptmodelableto“explainaway”theparticular
| world-engaging |     | system, | such | an outcome |     | makes adaptive |     |     |     |     |     |     |     |
| -------------- | --- | ------- | ---- | ---------- | --- | -------------- | --- | --- | --- | --- | --- | --- | --- |
sense. For, the only point of all that probabilistic betting combination of driving inputs, expectations, and precision
specified
is to drive action and decision, and action and decision (weighting on prediction error) that the doleful,
...
brain’sability
(agent-level) expectations. We thus depict minds and We do so courtesy ofthe to latch on to how
flow
selves in ways that are likely to make at best indirect the world is by means of a complex of sub-personal
...
gingbetweenthesevisions(themanifestandthescientific
|     |     |     |     |     | ence. But | it is | precisely | by such | means | that | biological |
| --- | --- | --- | --- | --- | --------- | ----- | --------- | ------- | ----- | ---- | ---------- |
image; Sellars 1962) remains essential if we are to gain beings are able to establish a truly tight mind-world
benefits
maximal from a better understanding of the linkage. Brains like these are statistical spongesstructured
...
itself.47
improve socialrelations and education, to increase human causal structure ofthe world
...
figure-ground
4.4. Sensingandworld 2004) and the impact of convexity cues in
mind–world d ep t h p e rc e p t io n ( B u rg e e t a l. 2 0 1 0) . A d d it i o n a ll y , W e is s
| What, then, | of the |     | relation | itself? Hohwy |               |             |                |           |           |            |                        |
| ----------- | ------ | --- | -------- | ------------- | ------------- | ----------- | -------------- | --------- | --------- | ---------- | ---------------------- |
|             |        |     |          |               | et al . ’s (2 | 0 0 2 ) B a | ye s -o p ti m | a la c co | u n t o f | a c la s s | o f s t a ti c( fi x - |
(2007) suggeststhat:
...
theorytellsusaboutthemindisthatperceptionisindirect…
|     |     |     |     |     | ated in | the presence | of  | active | eye | movements | during |
| --- | --- | --- | --- | --- | ------- | ------------ | --- | ------ | --- | --------- | ------ |
brain’s
what we perceive is the best hypothesis, as embodied smooth pursuit (see Freeman et al. 2010, and discussion
in a high-level generative model, about the causes in the inErnst2010).Perceptualexperience,evenintheseillusory
outerworld.(Hohwy2007,p.322) cases,thuslookstobeveridicallytrackingstatisticalrelations
...
|     |     |     |     |     | only because | of such | sub-personal |     | complexities |     | that agents |
| --- | --- | --- | --- | --- | ------------ | ------- | ------------ | --- | ------------ | --- | ----------- |
thesensedsceneasbythedrivingsignalsthemselves.Even
...
| --- | --- | --- | --- | --- | -------- | ------- | ------------ | --- | --------- | ----- | ------- |
anexpectedeventdoesnotneedtobeexplicitlyrepresentedor
|     |     |     |     |     | sider? Isitbestseen |     | asanalternativetomainstreamcom- |     |     |     |     |
| --- | --- | --- | --- | --- | ------------------- | --- | ------------------------------- | --- | --- | --- | --- |
...
brain’s
ary, correct the best guessing concerning what is not think we are yet in a position to answer this question
...
flow
marked when error signals, in a well-functioning brain, they suggest that the forward of sensory data is
flow
drivethekindsofplasticitythatresultinperceptuallearn- replaced by the forward of prediction error. This
...
|     |     |     |     |     |     |     | “error | units” |     | “representation |     |
| --- | --- | --- | --- | --- | --- | --- | ------ | ------ | --- | --------------- | --- |
texts)doingmuchoftheheavylifting,itremainscorrectto functionally distinct and
...
flips.
animportantearlyversionofanunsupervisedmultilayerlearning the best interpretation Attention thus engages the same
device,or“deeparchitecture”(Hinton2002;2007b;2010;Hinton
(broadlyBayesian)mechanism,butviaadifferent(andpotentially
...
thecaseofambiguousfigures(asdemonstratedbyMeng&Tong
| 4. This       | names | the probability | of      | an event | (here,   | a worldly |        |     |     |     |     |     |
| ------------- | ----- | --------------- | ------- | -------- | -------- | --------- | ------ | --- | --- | --- | --- | --- |
| cause), given | some  | set of prior    | beliefs | and the  | evidence | (here,    | 2004). |     |     |     |     |     |
Thisisalsoknown(see,e.g.,Fristonetal.2009)as“active
| the currentpattern |     | of sensorystimulation). |     | For | our | purposes,it | 12.         |     |                  |     |             |     |
| ------------------ | --- | ----------------------- | --- | --- | --- | ----------- | ----------- | --- | ---------------- | --- | ----------- | --- |
|                    |     |                         |     |     |     |             | inference.” |     | “action-oriented |     | processing” |     |
thus names the probability of a worldly (or bodily) cause, con- I coin predictive as it
ditionedonthesensoryconsequences. makesclearthatthisisanaction-encompassinggeneralizationof
|     |     | “predictive | processing” |     |     |     |     |     |     |     |     |     |
| --- | --- | ----------- | ----------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
5. In speaking of rather than resting the (hierarchical) predictive coding story about perception. It
withthemorecommonusage“predictivecoding,”Imeantohigh-
|     |     |     |     |     |     |     | also suggests | (rightly) |     | that action becomes | conceptually | primary |
| --- | --- | --- | --- | --- | --- | --- | ------------- | --------- | --- | ------------------- | ------------ | ------- |
...
error–see
tive coding. Rather, it is the use of that strategy in the special sensory signal so as to reduce sensory prediction
Friston’s
contextofhierarchicalsystemsdeployingprobabilisticgenerative Friston (2009, p. 295). In addition, most recent work
models.Suchsystemsexhibitpowerfulformsoflearningandare on active inference looks to involve a strong commitment (see
ableflexiblytocombinetop-downandbottom-upflowsofinfor-
|     |     |     |     |     |     |     | especially | Friston | 2011a) | to the wholesale | replacement | of value |
| --- | --- | --- | --- | --- | --- | --- | ---------- | ------- | ------ | ---------------- | ----------- | -------- |
mationwithinamultilayercascade. functions,consideredasdeterminantsofaction,withexpectations
(“priorbeliefs,”thoughnotethat“belief”hereisverybroadlycon-
| 6. In | what follows, | the notions | of  | prior, empirical |     | prior, and |     |     |     |     |     |     |
| ----- | ------------- | ----------- | --- | ---------------- | --- | ---------- | --- | --- | --- | --- | --- | --- |
...
“Action-oriented
downprobabilisticgenerativemodelswithinamultilayerarchitec- relations linking action and perception. predic-
processing,”
ture,itistheorganizationalstructureoftheneocortexthatmost tive as I shall use the term, remains deliberately
...
|     |     |     |     |     |     | “best | influential |     |     |     |     | (reflective) |
| --- | --- | --- | --- | --- | --- | ----- | ----------- | --- | --- | --- | --- | ------------ |
example, in nonhuman animals, but simply to isolate the philosophical work concerning high level
fit.” intentionsandactions:specifically,Velleman’s(1989)accountof
| Nor | is it | to rule out | the possibility |     | that, | moment-to- |     |     |     |     |     |     |
| --- | ----- | ----------- | --------------- | --- | ----- | ---------- | --- | --- | --- | --- | --- | --- |
flow
moment, details of the large-scale routing of information practical reasoning in which intentions to act are depicted as
self-fulfillingexpectationsaboutone’sownactions(see,e.g.,Vel-
| within the | brain     | might depend | on gating  | effects    | that, | although   |                  |     |     |     |     |     |
| ---------- | --------- | ------------ | ---------- | ---------- | ----- | ---------- | ---------------- | --- | --- | --- | --- | --- |
...
“…surprise
8. Ihaveadoptedtheneuroanatomistpracticeoflabelingcon- window on surprise (i.e., surprisal) itself, since
|     |     | “backward” | “forward” |     |     |     |     | quantified |     |     |     | can” |
| --- | --- | ---------- | --------- | --- | --- | --- | --- | ---------- | --- | --- | --- | ---- |
nections simply as and so as to avoid the cannot be by an agent, whereas free energy
|     |     |     |     | “feedback” |     | “feedfor- |     |     |     |     |     |     |
| --- | --- | --- | --- | ---------- | --- | --------- | --- | --- | --- | --- | --- | --- |
functional implications of the labels and (Friston 2010, p. 55). I read this as meaning, in the present
ward.”
This is important in the context of predictive processing context, that prediction error is organismically computable,
...
flowingpredictions–seeFriston(2005),Hohwy(2007),anddis-
thepresenttreatment.
...
| ------------------------------------------------------- | --- | --- | --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- |
Thiskindofefficiency,asoneoftheBBSrefereesnicely
| tive, and | in this | respect it differs | from | the kinds | of  | error signal | 16. |     |     |     |     |     |
| --------- | ------- | ------------------ | ---- | --------- | --- | ------------ | --- | --- | --- | --- | --- | --- |
familiarfromcontroltheoryandsystemsengineering.Thelatter noted, is something of a double-edged sword. For, the obvious
efficiencies
aremostlysimplesignalsthatrepresenttheamountoferror/mis- in forwardprocessing areherebought at the cost of
|     |     | (“prediction |     | signals”) |     |     |     |     |     |     |     |     |
| --- | --- | ------------ | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- |
match. The former error are much richer the multilevel generative machinery itself: machinery whose
...
|     |     |     |     |     |     | flow |     |     |     | “communicative | frugality” |     |
| --- | --- | --- | --- | --- | --- | ---- | --- | --- | --- | -------------- | ---------- | --- |
(Feldman & Friston 2010) to stand in for the forward of cingly made on the basis of so much
...
| refereeforsuggestingthisimportantclarification). |     |     |     |     |     |     |          |     |              |              |          | “predictive |
| ------------------------------------------------ | --- | --- | --- | --- | --- | --- | -------- | --- | ------------ | ------------ | -------- | ----------- |
|                                                  |     |     |     |     |     |     | Dumoulin | and | Hess (2006), | both of whom | contrast |             |
|                                                  |     |     |     |     |     |     | coding”  |     | “efficient   | coding,”     |          |             |
10. Hosoyaetal.herebuildonearlierworkbySrinivasanetal. with where the former uses top-
influence
(1982).Seealsoinformation-theoretictreatmentsofmutualinfor- down to subtract out predicted elements of lower-
influence
mation,suchasLinsker(1989).Foralargerperspective,seeClif- level activity, and the latter uses top-down to enhance
...
figures
tion, such as those induced by ambiguous like the of,forexample,fMRIdatasuchasMurrayetal.(2002)showing
...
soswitchingcannotbeinducedsimplybytheongoinginfluence reflect
|     |     |     |     |     |     |     | would | be alternatives, |     | since the dampening | might | then |
| --- | --- | --- | --- | --- | --- | --- | ----- | ---------------- | --- | ------------------- | ----- | ---- |
of the unexplained portions of bottom-up input. Instead, such eitherthesubtractionofwell-predictedpartsoftheearlyresponse
(“predictivecoding”)orthequashingoftherestoftheearlysignal
casesarebestexplainedbyasimilarprocessinvolvingattentional
...
|     |     |     | “explaining | away” |     |     | harder– |     |     |     |     |     |     |     |     |
| --- | --- | --- | ----------- | ----- | --- | --- | ------- | --- | --- | --- | --- | --- | --- | --- | --- |
dampening effects of also makes it dynamics of the very same neuronal substrate, with early
thoughnotimpossible–toteaseaparttheempiricalimplications
responsesencodingerrorandlateronessettlingintoarepresen-
ofpredictivecodingand“evidenceaccumulation”accountssuch “agreed content.”
|     |     |           |            |     |     |     |     | tation of | something | like |     |     | In  | a related | vein, |
| --- | --- | --------- | ---------- | --- | --- | --- | --- | --------- | --------- | ---- | --- | --- | --- | --------- | ----- |
|     |     | Shadlen’s | (2001)–for |     |     |     |     |           |           |      |     |     |     |           |       |
as Gold and a review, see Smith and Rat- Engeletal.(2001)discussthepotentialroleofneuralsynchrony
influence
cliff (2004). For an attempt to do so, see Hesselmann et al. as a means of implementing top-down on early
| (2010). |     |     |     |     |     |     |     | processing. |     |     |     |     |     |     |     |
| ------- | --- | --- | --- | --- | --- | --- | --- | ----------- | --- | --- | --- | --- | --- | --- | --- |
...
sideringaremathematicallyequivalenttosomeformsof“biased
|     |     |     |     |     |     |     |     | address to | the | 3rd Annual | Meeting | of  | the Cognitive |     | Science |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | --- | ---------- | ------- | --- | ------------- | --- | ------- |
competition”
|     |     | model, but | that | they nonetheless |     | suggest | different | Societyin1981. |     |     |     |     |     |     |     |
| --- | --- | ---------- | ---- | ---------------- | --- | ------- | --------- | -------------- | --- | --- | --- | --- | --- | --- | --- |
...
withthe“pure”structuredprobabilisticapproacheshighlightedby
treatmentalsoanticipates(althoughitdoesnotattempttomodel)
Griffithsetal.,buttheircomputationalrootslie(aswesawinsect.
| the | crucial | role of top-down | expectations |     | and | dynamic | forms of |     |     |     |     |     |     |     |     |
| --- | ------- | ---------------- | ------------ | --- | --- | ------- | -------- | --- | --- | --- | --- | --- | --- | --- | --- |
1.1)inworkonmachinelearningusingartificialneuralnetworks.
Bayesianinference.
21. Thanks to one of the BBS reviewers for suggesting this Importantly, however, hierarchical predictive processing models
“bottom-up”
importantnuancetothetemporalstory. now bring insights from cognitive neuroscience
...
meworkable(asGriffithsetal.correctlystress)toaccommodate
| tively | deprive | us of | such ongoing |     | context. | For some | recent |     |     |     |     |     |     |     |     |
| ------ | ------- | ----- | ------------ | --- | -------- | -------- | ------ | --- | --- | --- | --- | --- | --- | --- | --- |
...
conflict
more direct account in terms of the bare statistics of image- ance of deep and irreconcilable hereabouts, see
...
leagues’fascinatingworkon“latentsemanticanalysis”(Landauer
| ceptualillusionsasinvolvingBayesian |     |     |     |     | inferenceis | thatof | Hans- |     |     |     |     |     |     |     |     |
| ----------------------------------- | --- | --- | --- | --- | ----------- | ------ | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
...
firstorder)relationsbetweenwordsandthelargercontexts(sen-
(DeutscheDemokratischeRepublik)butsee,forexample,Geiss-
...
| ----- | --- | ----------------- | ---- | --- | ----------------- | --- | --------- | ---------------- | --- | --- | --- | --------- | --- | ------- | --- |
|       |     | flag              |      |     |                   |     |           |                  |     |     |     | Dehaene’s |     | “neural |     |
mean only to that the hierarchical structure supports many 34. For example, Stanislas (2009) re-
cycling”accountofthecomplexinterplaybetweenneuralprecur-
levelsofprocessingwhichdistributethecognitivelaborbybuild-
ingdistinct“knowledgestructures”thatspecializeindealingwith
|     |     |     |     |     |     |     |     | sors, cultural | developments, |     | and | neural | effects | within | the key |
| --- | --- | --- | --- | --- | --- | --- | --- | -------------- | ------------- | --- | --- | ------ | ------- | ------ | ------- |
differentfeaturesandproperties(soastopredicteventsandregu- cognitivedomainsofreadingandwriting.
“built-in”
laritiesobtainingatdifferingtemporalandspatialscales). 35. Such hyperpriors could, for example, be by
“winner-takes-all”
27. Theclearlineagehereiswithworkinconnectionismand forms of lateral (within layer) cortical inhi-
|           |     | artificial |          |       |       |           |        | bition–seeHohwyetal.(2008,p.691). |     |     |     |     |     |     |     |
| --------- | --- | ---------- | -------- | ----- | ----- | --------- | ------ | --------------------------------- | --- | --- | --- | --- | --- | --- | --- |
| recurrent |     | neural     | networks | (see, | e.g., | Rumelhart | et al. |                                   |     |     |     |     |     |     |     |
...
|     |     | “deep | architectures”– |     |     |     |     |     |     |     |     |     |     |     |     |
| --- | --- | ----- | --------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
ongoing work on see sect. 1.1) while tations, for example, may concern the reliability or shape of the
...
temporaryneuroscientificresearchandconjecture.
|     |     |     |     |     |     |     |     | they can | sound | quite exotic, | are | in no way | ad  | hoc additions | to  |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | ----- | ------------- | --- | --------- | --- | ------------- | --- |
...
Sokolov’s
nently in Eugene pioneering studies of the orienting compute some things). Like all priors, they then impact system
reflex. dynamicsinvariousways,accordingtotheirspecificcontents.
|     | Sokolov | concluded | that | the nervous | system |     | must learn |     |     |     |     |     |     |     |     |
| --- | ------- | --------- | ---- | ----------- | ------ | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
anddeploya“neuronalmodel”thatisconstantlymatchedtothe
|     |     |     |     |     |     |     |     | 38. This | worry | (concerning |     | the appeal | to  | hyperpriors) | was |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | ----- | ----------- | --- | ---------- | --- | ------------ | --- |
first
incoming stimulus, since even a reduction in the magnitude of drawn to my attention by Mark Sprevak (personal
“dishabituation”
| some | habituated | stimulus | could | engage |     |     | and | communication). |     |     |     |     |     |     |     |
| ---- | ---------- | -------- | ----- | ------ | --- | --- | --- | --------------- | --- | --- | --- | --- | --- | --- | --- |
...
levelsatwhichtheflowofpredictionandthemodulatingeffects
enrichedthepresenttreatment.
...
Clark’s
|     | belief | that | predictive | 1 coding | is  | likely to | be a | ubiquitous |     |     |     |     |     |     |
| --- | ------ | ---- | ---------- | -------- | --- | --------- | ---- | ---------- | --- | --- | --- | --- | --- | --- |
...
|     |          | don’t |       |      |          |     |            |          | NedBlockaandSusannaSiegelb |     |     |     |     |     |
| --- | -------- | ----- | ----- | ---- | -------- | --- | ---------- | -------- | -------------------------- | --- | --- | --- | --- | --- |
|     | However, | we    | think | that | evidence | for | predictive | 1 coding |                            |     |     |     |     |     |
aDepartmentofPhilosophy,NewYorkUniversity,NewYork,NY10003;
| warrants |     | a belief | in predictive |     | 2 coding. | And | it is | only from |     |     |     |     |     |     |
| -------- | --- | -------- | ------------- | --- | --------- | --- | ----- | --------- | --- | --- | --- | --- | --- | --- |
codingthatmanyofClark’slargerimplicationsfollow. bDepartmentofPhilosophy,HarvardUniversity,Cambridge,MA02138.
predictive 2
|     |             |     |      |      |            |          |     |              | ned.block@nyu.edu |     | ssiegel@fas.harvard.edu |     |     |     |
| --- | ----------- | --- | ---- | ---- | ---------- | -------- | --- | ------------ | ----------------- | --- | ----------------------- | --- | --- | --- |
|     | Clark makes | the | move | from | predictive | 1 coding | to  | predictive 2 |                   |     |                         |     |     |     |
...
plified
|         | version  | of        | their | proposal, | the       | experienced  |         | alternation |            |                  |                |                       |                |         |
| ------- | -------- | --------- | ----- | --------- | --------- | ------------ | ------- | ----------- | ---------- | ---------------- | -------------- | --------------------- | -------------- | ------- |
...
edge-drivenalternationbetweenrivalhypotheses(faceatlocation eithermakesfalsepredictions,orelseitoffersnodistinctiveexplanation
...
housescan’tcoexistthatway.Ifthisknowledge-drivenaccountis
visual/corticalhierarchy,therearetwokindsofunits:errorunits
thecorrectwaytounderstandsomethingasperceptuallybasicas and representation units. Representations propagate downward
binocularrivalry,thenpredictive 2 codingcanbegintolooklikea in the visual hierarchy whereas error signals propagate upward.
Errorinthissensemightbebettercalled“discrepancy,”sinceit
...
Butwhilethepredictive 2 codingmodelofbinocularrivalrymay thepredictivecoding(PC)frameworkasapplyingtoawiderange
ofphenomena,includingattention,whichClarksays“isachieved
beconsistentwithmuchofthedata,itisfarfromtheonlypossible
byalteringthegain(the‘volume,’touseacommonanalogy)on
explanationofthephenomenon.Hereisanoutlineofareasonable
theerror-units”(sect.2.3,para.6).Wearguethatformanyatten-
| predictive |     | 1 coding | account: | Given | the | generally | high-level | of  |     |     |     |     |     |     |
| ---------- | --- | -------- | -------- | ----- | --- | --------- | ---------- | --- | --- | --- | --- | --- | --- | --- |
cross-correlation in the inputs of our two eyes, the left eye tional phenomena, the predictive coding picture either makes
signal wouldpredict 1 greater correlationwith the righteye than false predictions, or else it offers no distinctive explanation of
...
“the
eye, which would predict 1 cross-correlated left eye signals . . . is that attention increases perceived contrast by enhancing
and so on. However far this particular proposal could be taken, representationofastimulusinamannerakintoboostingitsphys-
contrast”
the point is one can account for the phenomenon with low- ical (Ling & Carrasco 2006, p. 1243). A cross-modal
...
needn’t don’t effect,thelargertheeffectonperceivers’judgments.Increasing
|     | be  | the | driver | of the | visual | oscillation; | humans |     |     |     |     |     |     |     |
| --- | --- | --- | ------ | ------ | ------ | ------------ | ------ | --- | --- | --- | --- | --- | --- | --- |
...
thatdon’tappearstohavelittletodowithknowledge(seeBlake
Carrasco(2006)showedthatattendingtoastimuluswhileadapt-
[2001] for a review). Adopting a predictive 2 coding account is a ingtothatstimulushasthesameeffectasincreasingthecontrast
...
effectofadaptingtoa81–84%contrastadaptor.
|     | Usingpredictive |     | 2 codingasaGUTofbrainfunction,asClark |     |     |     |     |     |     |     |     |     |     |     |
| --- | --------------- | --- | ------------------------------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
proposes,isproblematicforseveralreasons.Thefirstproblemis
HowdotheseresultslookfromaPCperspective?Supposethat
unified
with the very idea of a grand theory of brain function. attimet 1 ,theperceiverisnotattendingtotheleftsideofspace
There is every reason to think that there can be no grand butnonethelessseesastripedgridontheleftwithapparentcon-
unifiedtheoryofbrainfunctionbecausethereiseveryreasonto
trastof70%.Becausethereisnomovementorotherchange,at
think that an organ as complex as the brain functions according timet 2 ,thevisualsystempredictsthatthepatchwillcontinueat
to diverse principles. It is easy to imagine knowledge-rich 70%. But at t 2 the perceiver attends to the patch, raising the
predictive 2 codingprocessesemployedingeneratingexpectations apparentcontrastto,say,82%.Nowatt 2 thereisanerror,adis-
crepancybetweenwhatispredictedandwhatis“observed.”Since
thatwewillconfrontajarofmustarduponopeningtherefriger-
atordoor,whileknowledge-freepredictive 1 codingprocesseswill thePCviewsaysattentionisturningupthevolumeontheerror
be used to alleviate the redundancy of sensory information. We representations, it predicts that at t 3 the signal (the represented
should be skeptical of any GUT of brain function. There is also contrast) should rise even higher than 82%. But that does
specific
| a problem |     | more |     | to predictive |     | 2 coding | as a brain | GUT. | nothappen. |     |     |     |     |     |
| --------- | --- | ---- | --- | ------------- | --- | -------- | ---------- | ---- | ---------- | --- | --- | --- | --- | --- |
Taking all of our experience and cognition to be the result of Therearetwoimportantlessons.First,theinitialchangesdue
high-level, knowledge-rich predictive 2 coding makes it seem as toattendingcomebeforethereisanerror(att 2 intheexample),
...
first
iments have demonstrated that our conscious perception of Thus, when lifting SWI-inducing cubes for the time, lifters
insufficient
events in the world represents not veridical sensory input, but will apply excess force to the large cube and apply
first
theintegrationofmultiplesourcesofevidencefromoursensory force to the small cube the time they lift them, but will lift
...
2008)–a
can be explained with this optimal integration strategy (Geisler (Flanagan et al. process that looks far more like the
...
motor“success.”
however,thetwokindsoferrorsappeartobecompletelyisolated
...
size–
incongruence is easily demonstrated with the famous SWIparadigmcanuncovertheoperationofmultiplepriorsoper-
illusion(SWI),firstdescribedin
weight 1891byAugustinChar- ating simultaneously, with different weightings and different
...
|     |     |     | one–an |     |     |     |     | nation–and, |     |     | “prior” |     |     |
| --- | --- | --- | ------ | --- | --- | --- | --- | ----------- | --- | --- | ------- | --- | --- |
(equally-weighted) larger effect that is persistent and to date, the term seems to serve only as a
...
| --------- | ----- | ------------ | ---- | -------- | -------- | --------- | --- | --------------- | --- | --- | --- | --- | --- |
individual’s
| the violation | of  | an  | expectations |     | about | how | heavy |     |     |     |     |     |     |
| ------------- | --- | --- | ------------ | --- | ----- | --- | ----- | --- | --- | --- | --- | --- | --- |
be–namely,
| each object | will |     | the | expectation |     | that the | large |     |     |     |     |     |     |
| ----------- | ---- | --- | --- | ----------- | --- | -------- | ----- | --- | --- | --- | --- | --- | --- |
...
toestablishaverypowerfulpriorforourperceptionsofheaviness
| (Flanagan   | et al. | 2008). Crucially, | however, |           | this prior | is not  | inte-    |                 |     |     |     |     |     |
| ----------- | ------ | ----------------- | -------- | --------- | ---------- | ------- | -------- | --------------- | --- | --- | --- | --- | --- |
|             |        | lifter’s          |          |           |            |         |          | DanielC.Dennett |     |     |     |     |     |
| grated into | the    | percept           | of       | how heavy | the        | objects | feel, as |                 |     |     |     |     |     |
CenterforCognitiveStudies,TuftsUniversity,Medford,MA02155.
onemightpredictfromaBayesianoptimalintegrationstandpoint.
|          | lifter’s |           |            |     |              |           |     | ddennett@tufts.edu |     |     |     |     |     |
| -------- | -------- | --------- | ---------- | --- | ------------ | --------- | --- | ------------------ | --- | --- | --- | --- | --- |
| Instead, | the      | conscious | perception |     | of heaviness | contrasts |     |                    |     |     |     |     |     |
ase.tufts.edu/cogstud/incbios/dennettd/dennettd.htm
thepriorexpectation,leadingsomeauthorstolabeltheeffectas
“anti-Bayesian”
(Brayanov & Smith 2010). Variants of the SWI Abstract:Clark’sessaylaysthefoundationforaBayesianaccountofthe
| can even | manifest | in a single, | unchanging, |     | object, | which | can be | “projection” |                |           |             |                  |      |
| -------- | -------- | ------------ | ----------- | --- | ------- | ----- | ------ | ------------ | -------------- | --------- | ----------- | ---------------- | ---- |
|          |          |              |             |     |         |       |        |              | of consciously | perceived | properties: | The expectations | that |
madetofeeldifferentweightsbysimplymanipulatinganindivid-
ual’s our brains test against inputs concern the particular affordances that
expectations of what they are about to lift (Buckingham & evolutionhasdesignedustocareabout,includingespeciallyexpectations
| Goodale2010). |     |     |     |     |     |     |     | ofourownexpectations. |     |     |     |     |     |
| ------------- | --- | --- | --- | --- | --- | --- | --- | --------------------- | --- | --- | --- | --- | --- |
significance
| The functional |          |      | of this             | contrastive |            | effect has | been  |                                                          |     |     |     |     |     |
| -------------- | -------- | ---- | ------------------- | ----------- | ---------- | ---------- | ----- | -------------------------------------------------------- | --- | --- | --- | --- | --- |
|                |          |      |                     |             | debate–why |            |       | The“Bayesian”brainasa“hierarchicalpredictionmachine”isan |     |     |     |     |     |
| the source     | of great | (and | largely unresolved) |             |            |            | would |                                                          |     |     |     |     |     |
ourperceptualsystembesostrickenwitherrors?Extendingthe enticing new perspective on old problems, for all the reasons
fields
conclusions of a recent study by Baugh and colleagues (Baugh Clark articulates, ranging over as disparate as neuroanat-
artificial
etal.2012),itcouldbeproposedthattheSWIisaproductofa omy, intelligence, psychiatry, and philosophy; but he
...
flaggingofoutliersinthestatisticsoftheenvironment.Thus,con-
Whilewaitingforthedetailstocomein,Iwanttosuggestsome
benefits
scious weight perception can be framed as an example of a task other that this perspective promises. If it turns out not
whereitisimportanttoemphasisetheunexpectednatureofthe to be sound, in spite of all the converging evidence Clark
efficient
stimuli, in a system which presumably favours more describes,wewillhaveallthemorereasonforregret.
Itiseverybody’sjob–butparticularlythephilosophers’job–to
codingofinformation.
Asliftingbehaviourisalargelypredictiveprocess,ourfingertip
negotiatethechasmbetweenwhatWilfridSellars(1962)calledthe
manifestimageandthescientificimage.Themanifestimageisthe
| forces are | driven | by our | expectations | of  | how heavy | something |     |     |     |     |     |     |     |
| ---------- | ------ | ------ | ------------ | --- | --------- | --------- | --- | --- | --- | --- | --- | --- | --- |
...
ficimageistheworldofquarks,atoms,andmolecules,butalso(in
presenceofliftingerrors.Thisprovidesthesensorimotorsystem
|     |     | worlds–lifting |     |     |     |     | flexible |     |     |     |     |     |     |
| --- | --- | -------------- | --- | --- | --- | --- | -------- | --- | --- | --- | --- | --- | --- |
with the best of both behaviour that is thiscontextparticularly)sub-personalneuralstructureswithpar-
...
“snap back”
drinker), but will automatically to the (generally knows, leaving lots of room for confusion and compensatory
adjustment(nicelyexemplifiedbythesurprise/surprisalpair).
...
| ------------ | -------------- | -------- | -------- | ------------ | ---------------- | ------ | --------- | --- | --- | ----------- | --- | --- | --- |
| recognition. | Converging     | evidence | suggests |              | that the initial |        |           |     |     |             |     |     |     |
...
| -------- | -------------- | ------------ | ----- | ----------- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
KarlFriston
Kukonaetal.2011),includinginformationexternaltothelinguis-
...
aboutaspeaker’slinguisticability(Arnoldetal.2007).Crucially,
k.friston@ucl.ac.uk
influenced
| lexical processing | is           |           | by information   |         | preceding the |           |     |            |         |                      |              |              |              |
| ------------------ | ------------ | --------- | ---------------- | ------- | ------------- | --------- | --- | ---------- | ------- | -------------------- | ------------ | ------------ | ------------ |
|                    |              |           |                  |         |               | Abstract: | Why | do brains  | have    | so many connections? |              | The          | principles   |
| target word        | by several   | syllables | or clauses       | (Dilley | & McAuley     |           |     |            |         |                      |              |              |              |
|                    |              |           |                  |         | listeners’    | exposed   | by  | Andy Clark | provide | answers              | to questions |              | like this by |
| 2008; Dilley       | & Pitt 2010) | and       | this information |         | affects       |           |     |            |         |                      |              |              |              |
...
| --- | --- | --- | --- | --- | --- | --------- | --- | ------ | ------- | --------- | ------------ | --- | -------- |
various constraints, despite their diversity, is consistent with the connections embody the fact that causes have particular consequences.
...
Clark’sframeworkalsohelpsexplainarecentsetofresultson Clark’s
|     |     |     |     |     |     | 1. Introduction. |     | It is a | pleasure | to comment | upon | Andy |     |
| --- | --- | --- | --- | --- | --- | ---------------- | --- | ------- | -------- | ---------- | ---- | ---- | --- |
...
flow
feed-forward of information. Farmer et al. (2006) demon- thebrainasaconstructiveandpredictivemachineinacompelling
...
childsavedthe…,whereanounisstronglyexpected),participants consciousness–remarkably,
|                                                         |     |     |     |     |     |            |     |     |               | without recourse |     | to mathematical |     |
| ------------------------------------------------------- | --- | --- | --- | --- | --- | ---------- | --- | --- | ------------- | ---------------- | --- | --------------- | --- |
| wereslowertoreadtheincomingnounwhentheformofit(i.e.,its |     |     |     |     |     | equations. |     |     |               |                  |     |                 |     |
|                                                         |     |     |     |     |     | Clark’s    |     |     | impressive–it |                  |     |                 |     |
phonological/orthographicproperties)wasatypicalwithrespectto synthesis is highlights the consistency
...
onset–timing
post-stimulus that is unambiguously associated through to motor control and embodiment. The key thing that
withperceptualprocessing–astrongneuralresponsewaselicited
emergesfromhistreatmentisthatminimisingsurpriseorsurpri-
...
representations.TheseresultsprovidesupportforClark’shypoth-
(developed)withinthisframework;forexample,theprincipleof
| esisthat“ifthepredictiveprocessingstoryiscorrect,weexpectto |     |     |     |     |     | efficient |        |         |        |     |        |               |     |
| ----------------------------------------------------------- | --- | --- | --- | --- | --- | --------- | ------ | ------- | ------ | --- | ------ | ------------- | --- |
|                                                             |     |     |     |     |     |           | coding | (Barlow | 1961); | the | notion | of perception | as  |
...
words,andtheseexpectationsarepropagatedtoperceptualcor- In what follows, I revisit three by
Clark–tothefree-energyprinciple,anditsincarnationslikepre-
tices(Tanenhaus&Hare2007).
dictivecodingandtheBayesianbrain.Specifically,theseare:(1)
Thisframeworkalsoservestospecifythefunctionalityofthepre-
...
| ----------------------------------------------------------- | --- | --- | --- | --- | --- | ------ | --- | --- | --- | --- | --- | --- | --- |
matchfrequentlyresultsinincreasedprocessingdifficulty,typically
|     |     |     |     |     |     | 2.  | Free-energy | and | predictive | coding. | Clark | frames | surprise |
| --- | --- | --- | --- | --- | --- | --- | ----------- | --- | ---------- | ------- | ----- | ------ | -------- |
...
Clark’sframework,theerrorsignalassumesfunctionality;inpart,
|     |     |     |     |     |     | (Mumford | 1992; | Rao | & Ballard | 1999; | Yuille | & Kersten | 2006). |
| --- | --- | --- | --- | --- | --- | -------- | ----- | --- | --------- | ----- | ------ | --------- | ------ |
...
action–because
etal.2011;Fineetal.underreview;Wellsetal.2009),prosody instance of the celebrated principle of least the
(Kurumadaetal.2012),orpragmatics(Grodner&Sedivy2011), average energy over time is also called action. Furthermore, it
1957)–because
ithasbecomeincreasinglyapparentthatreadersandlistenerscon- entails the maximum entropy principle (Jaynes
...
regularitiesofaspecificexperimentalcontext.Adaptationofexpec-
|     |     |     |     |     |     | because | they | govern | the behaviour | of  | known | physical | systems. |
| --- | --- | --- | --- | --- | --- | ------- | ---- | ------ | ------------- | --- | ----- | -------- | -------- |
tationsispredictedbyClark’sframework,anditmaybetakenas thing–for systems–is
|     |     |     |     |     |     | The | important |     | self-organising |     |     |     | that the |
| --- | --- | --- | --- | --- | --- | --- | --------- | --- | --------------- | --- | --- | --- | -------- |
...
Clark’s
In sum, hierarchical prediction machine hypothesis minimises sensory entropy. As articulated nicely by Clarke, we
providesaframeworkthatwebelievewillunifytheliteratureon can minimise free-energy (prediction errors) by either changing
predictioninlanguageprocessing.Thisunificationwillnecessarily
|     |     |     |     |     |     | our | predictions | (perception) |     | or changing | the | things | that we |
| --- | --- | --- | --- | --- | --- | --- | ----------- | ------------ | --- | ----------- | --- | ------ | ------- |
...
disorder–to
thestandardlevelsoflinguisticrepresentationthatareincorpor- need to resist a natural tendency to minimise
...
imperative–not yettotheshapeof aunifiedscienceofmindandaction.Theapparent
| fundamental |     |     | asa | causal explanation | for | how our |             |                      |     |           |     |                      |     |     |
| ----------- | --- | --- | --- | ------------------ | --- | ------- | ----------- | -------------------- | --- | --------- | --- | -------------------- | --- | --- |
|             |     |     |     |                    |     |         | convergence | of researchinterests |     | is offset | by  | a profounddivergence |     | of  |
brainswork.Thisisimportant,becauseanyevidencethatsuggests
theoreticalstartingpointsandidealgoals.
weareBayes-optimalcanbetakenasevidenceforactiveinference.
3.Thedarkroomproblem.Clarkintroducesandthen(almost) WesharewithClarkacommitmenttoexploringthedeepconti-
dismissesthedarkroomproblembyappealtoitinerant(explora- nuities of life, mind, and sociality (Froese & Di Paolo 2011).
...
|     |     |     | “grain | truth” |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | ------ | ------ | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
exactly right; however, the of in the dark room cannot be separated from acting and cognizing. Nevertheless,
–
p r o b le m c a n b e d i sm is s e d in a n e v e n sim p le r w a y b y n o ti n g we disagree with Clark’s theoretical premises and their ideal
efi
| th a t p r edi | c a tio n er | r o rs a | r e on ly d | n e d in | re la ti on t o p | r e dic t io n s . | consequences. |     |     |     |     |     |     |     |
| -------------- | ------------ | -------- | ----------- | -------- | ----------------- | ------------------ | ------------- | --- | --- | --- | --- | --- | --- | --- |
...
lit(ormoreexactly,weexpectourbodilymovementstobringthis this view,the mind is locked insidethe head and it follows that,
about).Inotherwords,thestateofaroombeingdarkissurprising as Clark puts it, “the world itself is thus off-limits” (sect. 1.2,
because we do not expect to occupy dark rooms. This surprise para. 1). This is the premise of internalism, from which another
depends upon (prior) expectations, but where do these prior assumption can be derived, namely that knowledge about the
beliefs come from? They come from evolution and experience, worldmustbeindirect.Accordingly,thereisaneedtocreatean
in the sense that if we did not have these prior beliefs, we internal model of the external source of the sensory signals, or,
...
encounters–
world (prior beliefs) that predicts the dynamics it Itisimportanttorealizethatthesetwopremisessetupthebasic
...
dence for surprise minimisation and its explanatory power. I am internalism may seem to be biologically plausible. As Clark
morecomplacentaboutthisissue,becausethefree-energyformu- observes,allthebrain“knows”about,inanydirectsense,arethe
l a t io n e x p la in s so m u c h a l re a d y . P ot en t e xa m p le s r e s to n ap p re c ia t - ways its own states (e.g., spike trains) flow and alter. However,
–
i n g t ha t a n a g en td o e s n o t h a v e a m o de l o f its w o r l d it is a m o d e l . theenactiveapproachpreferstointerpretthiskindofautonomous
In other words, the form, structure, and states of our embodied organizationnotasablack-boxprisonofthemind,butratherasa
sensorium–they
brains do not contain a model of the are that self-organizedperspectivalreferencepointthatservestoenactaset
model. This allows one to equate the long-term minimisation of of meaningful relations with its milieu (Di Paolo 2009). On this
states–and
surprise with the entropy of our physical (sensory) view,mindandactionarecomplexphenomenathatemergefrom
explainsourcurious(biological)abilitytoresistthesecondlawof the nonlinearinteractions of brain, body, andenvironment (Beer
thermodynamics (Ashby 1947). But what does this mean practi- 2000). Such a dynamical perspective supports a relational, direct
cally? It means that every aspect of our brain can be predicted realistaccountofperception(Noë2004;2009).
fromourenvironment.Thisseemsapowerfulexplanationforneu- An enactive approach to neuroscience exhibits many of the
roanatomyandneurophysiology.Aniceexampleistheanatomical virtuesoftheHPMapproach.Followingthepioneeringworkof
divisionintowhatandwherepathwaysinvisualcortex(Ungerlei- Varela (1999), it is also formalizable (in dynamical systems
der & Mishkin 1982). Could this have been predicted from the theory);ithasexplanatorypower(includingbuilt-incontext-sensi-
Yes–if
free-energy principle? anatomical structure in the brain tivity);anditcanberelatedtothefundamentalstructuresoflived
recapitulates causal structure in the environment, then one experience (including multistable perceptions). Indeed, it
...
s e g r e g a t e d n e u r o n a l s t ru c tu r e s . G iv e n t h a t o b je ct s c a n b ei n d i f fe r - g lo b a l se l f- or g a n i z a t io n o f b r a in a c t i vit y – fo r ex a m p le , v ia ne ur a l
|     |     |     |     |     | “w ” | “ .” |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | ---- | ---- | --- | --- | --- | --- | --- | --- | --- | --- |
e n t p l a c e s ,t h e y p o s s e s s se p a r a b l ea t tr ib u t e s o f h a t an d w h e r e s y n c h ro n y – r e q u i r e s e xt e n si v e u s a g e o f w h at C l ar k r e fe rs to a s
This translates into separate neuronal representations in segre- “backwardconnections”inordertoimposetop-downconstraints
| gated visual | pathways. | In  | summary, | the | evidence for | the free- | (Va r e la e | t a l . 2 0 | 0 1 ). |     |     |     |     |     |
| ------------ | --------- | --- | -------- | --- | ------------ | --------- | ------------ | ----------- | ------ | --- | --- | --- | --- | --- |
energyprinciplemaynotnecessarilybeinnextmonth’sscientific
|     |     |     |     |     |     |     | A d v an t | a g e o u s | ly , the enactive |     | approach | avoids | the | HPM’s |
| --- | --- | --- | --- | --- | --- | --- | ---------- | ----------- | ----------------- | --- | -------- | ------ | --- | ----- |
journalsbutmaylieintheaccumulatedwealthofempiricalneuro- essential requirement of a clean functional separation between
...
Clark’s “hierarchical machine” partofthesystem),thereareabnormalyeteffectivewaysofredu-
| Abstract: | In important | ways, |     |     | prediction |     |     |     |     |     |     |     |     |     |
| --------- | ------------ | ----- | --- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
cingpredictionerror,forexamplebystereotypicself-stimulation,
| (HPM) approachparallelstheresearchagendawehave |     |     |     |     | been | pursuing. |     |                                      |     |     |     |     |     |     |
| ---------------------------------------------- | --- | --- | --- | --- | ---- | --------- | --- | ------------------------------------ | --- | --- | --- | --- | --- | --- |
...
Commentary/Andy Clark: Predictive brains, situated agents, and thefuture ofcognitivescience
andreproducing–areonacontinuumofconnectedultimateand
whetheramovementisproducedbytheSMA.Thatisaverylow
...
|                 |          |        |      |         | else’s. | tance:findingamate,findingabettermate,ordying? |     |     |     |     |     |     |     |
| --------------- | -------- | ------ | ---- | ------- | ------- | ---------------------------------------------- | --- | --- | --- | --- | --- | --- | --- |
| which movements | are ours | rather | than | someone | It has  |                                                |     |     |     |     |     |     |     |
...
fitness
theagentofanactionratherthantosimplycontrolourownaction. time alternatives, predict the that would accrue or not
...
Clark’sarticlesuggeststhatourassumptionsarenotsooddinthe
| tion. It evolved | to control | movement, | not | to identify | the agent. |     |     |     |     |     |     |     |     |
| ---------------- | ---------- | --------- | --- | ----------- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
Becauseschizophrenicscannotattenuatethisactivitywhenvisually humancognitivesciencesandtheysignalnewempiricalresearch
aboutthemeaningsofanimalbehaviorintheunifiedcontextsof
monitoringactions,theycannotexperiencethemselvesasauthors
...
importantofreproductivedecisions.Tobefitnessenhancingincon-
predictivecodingthreadsweshouldbeabletounravelitentirely
temporarytime,reproductivedecisionsmustbeflexibleandmade
| from the | top down. But | the fact | that online | control | in schizo- |     |     |     |     |     |     |     |     |
| -------- | ------------- | -------- | ----------- | ------- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
phreniaisintactsuggeststhattheseamlinkingautomaticandvisu- against the unavoidable context of demography (Gowaty &
flexible,
ally guided motor control, while has been robustly Hubbell2005).Demographyisnotstatic:thingschange;stochastic
...
flexible reproductive decisions lif e o fd e c isi o n -m a k e r s( su rv i v a l p ro b a bil it y, s ),a n d t h e d i s tr ibu t io n
fi
|     |     |     |     |     |     | w i th in t h | e p o p ul | a ti o n o f | t n e s s | th a t w | o ul d b          | e c o n fe r | r e d fr o m |
| --- | --- | --- | --- | --- | --- | ------------- | ---------- | ------------ | --------- | -------- | ----------------- | ------------ | ------------ |
...
PatriciaAdairGowatyandStephenP.Hubbell enhancingreproductivedecisionsise,sandthew-distribution.
GowatyandHubbell(2005)hypothesizedthatindividuals,not
DepartmentofEcologyandEvolutionaryBiology,andInstituteofEnvironment flexibly
|     |     |     |     |     |     | sexes, are | under | selection | to  | modify | their | reproductive |     |
| --- | --- | --- | --- | --- | --- | ---------- | ----- | --------- | --- | ------ | ----- | ------------ | --- |
andSustainability,LosAngeles,CA90095;andSmithsonianTropical
ResearchInstitute,Unit9100,BOX0948,DPOAA34002-9998. decisions moment-to-moment as their ecological and social cir-
gowaty@eeb.ucla.edu shubbell@eeb.ucla.edu cumstanceschangetoenhancetheirinstantaneouscontributions
tolifetimemeanfitness(Fig.1).Stochasticvariationine,s,andl
...
fitness
changing demographic circumstances to predict their futures to adjust ment of that would be conferred through mating with
| actions flexibly | and adaptively. | Our | ecological/evolutionary |     | models of |         |                |       |      |             |     |                |     |
| ---------------- | --------------- | --- | ----------------------- | --- | --------- | ------- | -------------- | ----- | ---- | ----------- | --- | -------------- | --- |
|                  |                 |     |                         |     |           | this or | that potential | mate. | Once | sensitivity |     | and assessment |     |
...
| opportunity                     | for a unified | proximate | and ultimate | theory | of Bayesian |           |            |       |               |     |                 |         |          |
| ------------------------------- | ------------- | --------- | ------------ | ------ | ----------- | --------- | ---------- | ----- | ------------- | --- | --------------- | ------- | -------- |
|                                 |               |           |              |        |             | havior in | ways which | their | sensitivities |     | and assessments |         | predict  |
| animalbrains,senses,andactions. |               |           |              |        |             | fitness   |            |       |               |     |                 |         |          |
|                                 |               |           |              |        |             | are       | enhancing. | The   | analytical    |     | solution        | to this | model is |
Reading Clark suggests possible connections between proximate the Switch Point Theorem (SPT). An SPT graph shows the
causes of animal–not just human–perception, mind, and action rule for acceptance and rejection of each potential mate,
andtheirultimatecauses.Wesuggestthatitisworthconsidering rankedfrombestat1toworstatn,byasingleuniqueindividual
that nonhuman animals, not just humans, are Bayesian too, and in the population, given variation in e, s, l, n and the w-
| thatthe world | alsoappearstothem |     | as a setofintertwined |     | prob- | distribution. |     |     |     |     |     |     |     |
| ------------- | ----------------- | --- | --------------------- | --- | ----- | ------------- | --- | --- | --- | --- | --- | --- | --- |
ability density distributions. We think of all animals as Bayesian The assumptions of the analytical solution as to how many
...
Commentary/Andy Clark: Predictivebrains,situated agents,and thefutureof cognitive science
|     |     |     |     | adaptivelyflexiblebehavior |     |     | (modified | fromfigures |     |     |     |
| --- | --- | --- | --- | -------------------------- | --- | --- | --------- | ----------- | --- | --- | --- |
Figure 1(Gowaty& Hubbell). The hypothesisfor the evolution of in Gowaty&
Hubbell2005;2009).
...
individual’s
instantaneouscontributionstolifetimefitness. situating personal narratives at the top of an knowledge
|     |     |     |     | hierarchy. | Narrative | representations |     | function | as high-level | generative |     |
| --- | --- | --- | --- | ---------- | --------- | --------------- | --- | -------- | ------------- | ---------- | --- |
Theanalyticalsolutionofwhomtoacceptandrejectformatingis
|     |     |     |     | models that | direct | our attention | and | structure | our expectations |     | about |
| --- | --- | --- | --- | ----------- | ------ | ------------- | --- | --------- | ---------------- | --- | ----- |
theswitchpointtheorem(SPTinFig.1).
|     |     |     |     | unfolding | events. Implications |     | for integrating |     | scientific | and humanistic |     |
| --- | --- | --- | --- | --------- | -------------------- | --- | --------------- | --- | ---------- | -------------- | --- |
...
SPTsuggeststhatfitnessdrivesall. encode a great deal of information about the world, including
...
|           |             |     |     | intentions      | of multiple | social | agents    | (Mar            | & Oatley | 2008).        | It is |
| --------- | ----------- | --- | --- | --------------- | ----------- | ------ | --------- | --------------- | -------- | ------------- | ----- |
...
|     |     |     |     | representations | thus | appear | to function |     | as high-level | generative |     |
| --- | --- | --- | --- | --------------- | ---- | ------ | ----------- | --- | ------------- | ---------- | --- |
aRotmanSchoolofManagement,UniversityofToronto,Toronto,ONM5S3E6,
|     |     |     |     | models of | the sort | that | Clark describes, |     | structuring | our | expec- |
| --- | --- | --- | --- | --------- | -------- | ---- | ---------------- | --- | ----------- | --- | ------ |
Canada;bDepartmentofPsychology,YorkUniversity,Toronto,ONM3J1P3,
...
|                         |                    |     |     | Mandler | 1984). Such | representations |     | are | particularly | crucial | for |
| ----------------------- | ------------------ | --- | --- | ------- | ----------- | --------------- | --- | --- | ------------ | ------- | --- |
| jacob.hirsh@utoronto.ca | www.jacobhirsh.com |     |     |         |             |                 |     |     |              |         |     |
anticipatingthesequentialunfoldingofeventsovertime,allowing
| mar@yorku.ca | www.yorku.ca/mar |     |     |     |     |     |     |     |     |     |     |
| ------------ | ---------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
forthepredictionofactionsandoutcomeswithinachainofevents
| peterson@psych.utoronto.ca |     | www.psych.utoronto.ca/users/ |     |          |        |             |            |      |            |          |     |
| -------------------------- | --- | ---------------------------- | --- | -------- | ------ | ----------- | ---------- | ---- | ---------- | -------- | --- |
|                            |     |                              |     | (Abelson | 1981). | Integrating | narratives | into | predictive | modeling |     |
peterson
36 BEHAVIORALANDBRAINSCIENCES(2013)36:3

Commentary/Andy Clark: Predictive brains, situated agents, and thefuture ofcognitivescience
individual’s
means that information consistent with an currently high-level generative models (instantiated as narrative represen-
|     |     |     | “explained | away” |     |     |     |     |     |     |     |     |
| --- | --- | --- | ---------- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
active narrative schema will be in the fashion tations) is thus one of the core requirements for mental health
...
individual’s
| during development |           | (Nelson         | & Fivush | 2004).       | An         |             |            |                    |     |        |     |     |
| ------------------ | --------- | --------------- | -------- | ------------ | ---------- | ----------- | ---------- | ------------------ | --- | ------ | --- | --- |
...
2003). Inplacingthesenarrativestructuresatthetopofthepre-
individual’s
| dictive hierarchy, |     | an  | cultural | context | is  | afforded a |     |     |     |     |     |     |
| ------------------ | --- | --- | -------- | ------- | --- | ---------- | --- | --- | --- | --- | --- | --- |
powerfulinfluenceonthetop-downregulationofdomain-specific
doi:10.1017/S0140525X12002336
| knowledge | structures | and | behavioral | patterns | (Kitayama | &   |     |     |     |     |     |     |
| --------- | ---------- | --- | ---------- | -------- | --------- | --- | --- | --- | --- | --- | --- | --- |
LinusHolmandGuyMadison
Cohen 2010).
...
“when”
|             |       |          |                  |     |            |          | make. We | extend that scope | by addressing |     | the | aspect of |
| ----------- | ----- | -------- | ---------------- | --- | ---------- | -------- | -------- | ----------------- | ------------- | --- | --- | --------- |
| view of the | world | (Sellars | 1963). Narrative |     | psychology | acknowl- |          |                   |               |     |     |           |
“manifest” perception and action. Successful interaction with the environment
| edges the | importance | of these |     | images, | as  | they guide |     |     |     |     |     |     |
| --------- | ---------- | -------- | --- | ------- | --- | ---------- | --- | --- | --- | --- | --- | --- |
individual’s requires predictions of everything from millisecond-accurate motor
an expectations and shape the cascade of cognitive timing to far future events. The hierarchical framework seems
operations that give rise to subjectiveexperience. Within such a appropriatefortiming.
individual’s
| framework, | a full | appreciation | of  | an  | subjectivity | is  |     |     |     |     |     |     |
| ---------- | ------ | ------------ | --- | --- | ------------ | --- | --- | --- | --- | --- | --- | --- |
...
Althoughhigher-ordernarrativesinfluencecognitiveprocesses,
|     |     |     |     |     |     |     | ensemble | music performance | requires | precise | estimation | of the |
| --- | --- | --- | --- | --- | --- | --- | -------- | ----------------- | -------- | ------- | ---------- | ------ |
...
difficulty
selectively focusing attention on the most relevant the world is typically an ill-posed problem: How does the
...
|     | “explain | away” |     |     |     |     | specified |     |     |     |     |     |
| --- | -------- | ----- | --- | --- | --- | --- | --------- | --- | --- | --- | --- | --- |
the ability to the majority of the sensory infor- problems in the sensory signal. In both cases, prior
...
“error”informationbeingcarrieduptheneuralhierarchy(Hirsh
structuredeventsascyclesreducestheentropyinthesignaland
allowsformoreefficientstorage.Actioncanservetofurtherboot-
etal.2012).Thishasdownstreamconsequencesfortheindividual,
...
narrativeaccountsofone’sexperi- mentstootherpeople’smovements(Demosetal.2012;Merker
developingclearlyarticulated
encesisassociatedwithanumberofpositivehealthbenefits(Pen-
|     |     |     |     |     |     |     | et al. 2009). | Just like active | interactions | with | an object | improve |
| --- | --- | --- | --- | --- | --- | --- | ------------- | ---------------- | ------------ | ---- | --------- | ------- |
nebaker&Seagal1999). perception (Harman et al. 1999), timed activities have been
Althoughtheaffectivesignificanceofpredictionerrorswasnot
|     |     |     |     |     |     |     | shown to | improve the reliability | of  | temporal | perception | (Grahn |
| --- | --- | --- | --- | --- | --- | --- | -------- | ----------------------- | --- | -------- | ---------- | ------ |
highlightedinClark’sarticle,thenarrativeaccountanditsbaseof benefit
|     |     |     |     |     |     |     | & McAuley | 2009; Phillips-Silver | &   | Trainor | 2007). | A of |
| --- | --- | --- | --- | --- | --- | --- | --------- | --------------------- | --- | ------- | ------ | ---- |
subjectivitymakesthisclear,aspredictionerrorscanreflectviola-
|     |     |     |     |     |     |     | having induced | the rhythm | is that | violations | of  | rhythm are |
| --- | --- | --- | --- | --- | --- | --- | -------------- | ---------- | ------- | ---------- | --- | ---------- |
...
experiencedasfairlybenignwhileviolationsofone’scorenarra-
|     |     |     |     |     |     |     | Timing could | then be established |     | by coincidence |     | detection in |
| --- | --- | --- | --- | --- | --- | --- | ------------ | ------------------- | --- | -------------- | --- | ------------ |
...
|     |     | flexibly |     |     |     | one’s |     |     |     |     |     |     |
| --- | --- | -------- | --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- |
framework, the ability to maintain the integrity of its uncertainty should reasonably increase with timing over long
...
| --- | --- | --- | --- | --- | --- | --- | --------- | --------------- | --- | --------- | --- | --- | --- |
durations.Indeed,humantemporalperceptionandproductiondo
deterioratemonotonicallywithtimescale(Buhusi&Meck2005). processes: Distinguishing intransigence
Exactlyhowthehumansystemdealswithtemporalsignaluncer- from dogmatism
taintyremainsanopenquestion.
Akeynotioninthetargetarticleisthehierarchicaldivisionof doi:10.1017/S0140525X12002403
...
| ofmotortimingcannotfeasiblybecarriedoutdirectlybythepre- |     |     |     |     |     |     | Australia. |     |     |     |     |     |     |
| -------------------------------------------------------- | --- | --- | --- | --- | --- | --- | ---------- | --- | --- | --- | --- | --- | --- |
frontalcorticalregionsinvolvedinworkingmemory,duetotrans- elias.khalil@monash.edu www.eliaskhalil.com
...
confirm
effector representation and the cerebellum) and involve a more theory is based on facts, more facts can either falsify or a
theory.Incaseswherethetheoryisaboutthechoiceofabenchmarkor
directpathwaybetweensensoryinputandmotoroutput.Incon-
|             |             |     |               |      |          |     | a standard, | more facts can | only | make a | theory either | more | or less |
| ----------- | ----------- | --- | ------------- | ---- | -------- | --- | ----------- | -------------- | ---- | ------ | ------------- | ---- | ------- |
| trast, when | observation | and | action become | more | detached | in  |             |                |      |        |               |      |         |
warranted.
time,thewindowofopportunityforplanningopensup,involving
...
cessesinputinformationinawaythatconfirmsitspriorsoritspre-
| tinction in | neural representation, |     | for example, | above | and | below |     |     |     |     |     |     |     |
| ----------- | ---------------------- | --- | ------------ | ----- | --- | ----- | --- | --- | --- | --- | --- | --- | --- |
...
specific(Morroneetal.2005;
Nagarajanetal.1998), andunder While the top layers generate priors, the lower layers process
some conditions even limited to spatial locations (Burr et al. input data. The brain amounts to the dynamics of image-
unified
2007; Johnston 2006). Additionally, there appear to be break- making, where the top-down process generates images,
...
1999)–further
supporting the notion that longer time intervals input data are not fully manipulated by the priors. As such, it is
...
unified,
ation,alargerpartoftheprefrontalcortexgetsactivated(Lewis& a that is, meaningful, image of the real world. The top
...
fulfilltheneedforunity.Second,thebrainneedstoaccommodate
| network | is also largely | overlapping | with | those | employed | by  |     |     |     |     |     |     |     |
| ------- | --------------- | ----------- | ---- | ----- | -------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
world.Ifthebrainperformsonlythefirstfunction,thatis,preser-
etal.2000;Owenetal.2005),suggestingthattimingconstitutes
a general cognitive control problem at longer time durations. vingtheunityoftheimage,thebrainwouldgenerateimagesthat,
unified,
The hierarchical organization from accurate and dedicated although are disconnected from reality. On the other
flexible
timing devices at sensory levels and less accurate but hand, if the brain performs only the second function, that is,
...
conflict
Communication of temporal information across the levels of mately as a between rationalism (demanding unity of
...
|                 |         |        |           |       | influence |     | entkindsoftheory-ladencognitiveprocesses:thefirst,whichcan |     |     |     |     |     |     |
| --------------- | ------- | ------ | --------- | ----- | --------- | --- | ---------------------------------------------------------- | --- | --- | --- | --- | --- | --- |
| with prefrontal | working | memory | processes | might | still     |     |                                                            |     |     |     |     |     |     |
becalled“perception-laden”processes,whereone’stheorycanbe
| control at | shorter | time frames | without | interfering | in  | direct |     |     |     |     |     |     |     |
| ---------- | ------- | ----------- | ------- | ----------- | --- | ------ | --- | --- | --- | --- | --- | --- | --- |
control, such as in initiation of a drumming exercise, without ultimatelycorrected by sensory input; the second, whichcan be
|     |     |     |     |     |     |     | “conception-laden” |     |     |     | one’s |     |     |
| --- | --- | --- | --- | --- | --- | --- | ------------------ | --- | --- | --- | ----- | --- | --- |
employingmomenttomomentvolitionalcontroloftheindividual called processes, where theory cannot
findings
beats. Recent from our research group suggest that beultimatelycorrectedbysensoryinput.
...
flat.
forexample,effectorcoordination(Holmetal.,inpress).Further- weather or that the Earth is In light of sensory input, and
| more,thereisawell-establishedyetpoorlyspecifiedrelationship |     |     |     |     |     |     | Bayes’ |           |            |      |              |     |       |
| ----------------------------------------------------------- | --- | --- | --- | --- | --- | --- | ------ | --------- | ---------- | ---- | ------------ | --- | ----- |
|                                                             |     |     |     |     |     |     | using  | rule, one | may adjust | such | a prediction | and | reach |
between intelligence and simple motor timing (Galton 1883; the conclusion that the weather will be stable and the Earth is
round.Manypeoplemaynotadjustquicklyandinsiston“explain-
Madisonetal.2009).Moreresearchisclearlyneededtoidentify
| howhigh-leveltemporalexpectationsmightinfluencebriefinter- |     |     |     |     |     |     | away” |                     |       |         |          |              |     |
| ---------------------------------------------------------- | --- | --- | --- | --- | --- | --- | ----- | ------------------- | ----- | ------- | -------- | ------------ | --- |
|                                                            |     |     |     |     |     |     | ing   | the data to justify | their | priors. | But such | manipulation |     |
valtiming.Anotherimportantquestionishowthebrainidentifies
|     |     |     |     |     |     |     | can be delineated | from | the normal | course | of belief | adjustment. |     |
| --- | --- | --- | --- | --- | --- | --- | ----------------- | ---- | ---------- | ------ | --------- | ----------- | --- |
...
sensorydata,inthefinalanalysis,todominatetop-downpriors.
operation.
...
“animals
identical sensory organs but different action repertoires might response, Clark suggests that like us live and forage
‘expect’
haveverydifferentviewsoftheworld. in a changing and challenging world, and hence to
|     |     |     |     |     |     |     |     |     |     |     | ‘itinerant’ | strategies” |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----------- | ----------- | --- | --- | --- |
Istheconceptofnormativeprinciplesplausibleinviewofour deploy quite complex (sect. 3.2, para. 2).
first,
knowledgeofcorticalnetworks?Neuronalcomputationsarecon- At this response seems tautological: We act so that we
...
coding–that
latter has served as an argument for sparse is, low in complex and interesting ways. The tautology is broken by
meanactivityatconstantvarianceofactivity(Barlow1961).The invoking a prior expectation on action, one presumably hard-
fields
insight that receptive of simple cells in primary visual wired and selected for by evolutionary pressures. But, such an
...
|     |     |     |     |     |     |     |     | “Dark | Dilemma” |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ----- | -------- | --- | --- | --- | --- | --- | --- |
Importantly, both optimization principles can be easily Room may potentially be found in a different
...
|     |     |     |     |     |     |     |     | quantifies |     | agent’s |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | --- | ------- | --- | --- | --- | --- | --- |
andstabilitytopredictabilityasanoptimizationprinciplerequires which an informational cost for representing
quantifi-
criticalextensions.Phillipsetal.(1995)putforwardaveryprom- the sensory input by its internal model. An alternative
...
Phillips’ MIquantifiestheinformationsharedbetweentwodistributions–
| evance. The | relation | of this | approach | (see |     | commentary |     |     |     |     |     |     |     |     |     |
| ----------- | -------- | ------- | -------- | ---- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
“higher”
cognitive functions as well as giving rise to a true tionalcostofa(bad)internalmodel,whileMIistheinformational
...
| entropy, | for    | escaping     | the | “Dark | Room”       |     |     |            |            |           |             |         |              |             |          |
suchchangesthattheprinciplesofmaximizingMIandminimizing
...
|     |     |     |     |     |     |     |     |         | inputs–that |     |           |      | “Dark | Room.” |         |
| --- | --- | --- | --- | --- | --- | --- | --- | ------- | ----------- | --- | --------- | ---- | ----- | ------ | ------- |
|     |     |     |     |     |     |     |     | sensory |             | is, | it dwells | in a |       |        | Here, a |
DanielYing-JehLittleandFriedrichTobiasSommer
|     |     |     |     |     |     |     |     | trivial model | can | perfectly | predict | sensory | inputs | without | any |
| --- | --- | --- | --- | --- | --- | --- | --- | ------------- | --- | --------- | ------- | ------- | ------ | ------- | --- |
RedwoodCenterforTheoreticalNeuroscience,UniversityofCalifornia–
informationcost.Entropythusgoestozerosatisfyingtheprinciple
...
a“DarkRoom,”an
http://redwood.berkeley.edu/wiki/Fritz_Sommer MIprinciple. Instead,of entering agentfol-
|     |     |     |     |     |     |     |     | lowing a | principle | of maximal | MI  | would | seek | out conditions | in  |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | --------- | ---------- | --- | ----- | ---- | -------------- | --- |
Abstract:Abehavioraldrivedirectedsolelyatminimizingpredictionerror
|                |          |         |            |        |             |             |        | which its  | sensory         | inputs      | vary in | a complex, | but         | still predictable, |          |
| -------------- | -------- | ------- | ---------- | ------ | ----------- | ----------- | ------ | ---------- | --------------- | ----------- | ------- | ---------- | ----------- | ------------------ | -------- |
...
unsatisfying. We suggest an alternate information theoretic Thus,MIbalancespredictabilitywithcomplexity.Passively,max-
...
Theprediction–complexitydualityofMIanditsimportanceto
| insightful | review | of the strengths |     | and limitations |     | of hierarchical |     |     |     |     |     |     |     |     |     |
| ---------- | ------ | ---------------- | --- | --------------- | --- | --------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
learninghasbeenarecurringfindingincomputationalmethods.
| predictive | processing | and | its application |     | to modeling | actions | as  |     |     |     |     |     |     |     |     |
| ---------- | ---------- | --- | --------------- | --- | ----------- | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Crutchfield
myriad functions of the brain. Here, we hope to contribute to approach for dynamical systems of and Young
the discussion by reconsidering a particular challenge to the (1989) and the Information Bottleneck Method of Tishby et al.
identified
minimum prediction error (MPE) principle by Clark, (1999)foranalyzingtimeseries.Recently,theInformationBottle-
|     |     | “Dark |     | Dilemma,” |     |     |     |     |     |     |     |     |     |     |     |
| --- | --- | ----- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
which we dub the Room and by offering an neckmethodhasbeenextendedtoactionselectionbyStill(2009).
...
| ------------- | --- | ----- | -------------- | --- | ----------- | -------- | ----------------- | --- | --- | --- | --- | --- | --- | --- |
Specifically,
But we also believe its explanatory value is limited. Concrete level description. On the concrete conceptual level,
...
filter
makesanimals,eventhesimplestones,ventureoutoftheirdark are proposed to explain away the incoming signal or away
...
| the cortical |     | hierarchy  | predicts |     | the expected |     |                           |              |          |                            |        |             |        |        |
|              |     |            |          |     |              |     | remains                   | an empirical | question |                            | which  | combination | of     | these  |
suffices
future models to explain the rich and diverse cortical response
...
conceptuallevel,itprovidesaunifyingframeworkforperception,action,
|     |     |     |     |     |     |     | nize on | attention | (Hohwy | 2012). | A recent | brain | imaging | study |
| --- | --- | --- | --- | --- | --- | --- | ------- | --------- | ------ | ------ | -------- | ----- | ------- | ----- |
...
| -------------------- | --- | ----- | ----------- | ---------------- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
elements and mechanisms of predictive coding models (estimation of et al. 2012). Consistent with the predictive coding framework,
predictions,predictionerrors,andinternalmodels). auditory-cuedstimuliledtoreducedV1fMRIactivity.Although
profile
|     |     |     |     |     |     |     | the overall | activity | was reduced, |     | the activation |     | was | more |
| --- | --- | --- | --- | --- | --- | --- | ----------- | -------- | ------------ | --- | -------------- | --- | --- | ---- |
“sharpened,”
Abstractleveldescription.Understanding the brain as a predic- distinct, for the expected conditions as measured
...
fies
tation,theframeworkascribesafunctiontointernalmodelsand the remaining prediction error (Hohwy 2012; Spratling
...
“sending”
communication (i.e., maintaining internal models) and (2) the tions at the precision level of the brain area (i.e.,
“receiving”
brain processes prior to stimulation onset (i.e., predictive coarse), or at the precision level of the brain area
...
confirms
that saccadic updating incorporates predictions gener- tion errors, and different accounts of feedforward connections
...
influence
in baseline activity subsequent perception, and a inglycompellingwithattentionfromsophisticatedhumanneuroi-
...
“representation
under revision). If the brain would be seen as a deviationsofpredictivecodinginagingandneuropsychiatricdis-
machine”insteadofa“predictionmachine,”onewouldnotlook
easessuchasschizophrenia(Sandersetal.2012).
...
| local         | neural                       | circuits. Narrow   | receptive-field  |            | selectivity    | is                | necessary to |               |             |               |          |          |               |          |        |
| ------------- | ---------------------------- | ------------------ | ---------------- | ---------- | -------------- | ----------------- | ------------ | ------------- | ----------- | ------------- | -------- | -------- | ------------- | -------- | ------ |
|               |                              |                    |                  |            |                |                   |              | Infomax       | (Kay et     | al. 1998;     | Kay &    | Phillips | 2010;         | Phillips | et al. |
| avoid         | the curse-of-dimensionality, |                    |                  | but local  | activities     | can               | be made      |               |             |               |          |          |               |          |        |
|               |                              |                    |                  |            |                |                   |              | 1995), which  | synthesizes |               | evidence | from     | neuroanatomy, |          | neuro- |
...
thereforecrucialtotheissuesClarkexamines. is further strengthened by evidence from psychopathology as
|     |     |     |     |     |     |     |     | reviewed | by Phillips | and | Silverstein | (2003), | and | extended | by  |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | ----------- | --- | ----------- | ------- | --- | -------- | --- |
MuchinClark’sreviewisoffundamentalimportance.Probabilistic
manysubsequentstudies.KördingandKönig(2000)arguefora
...
ofthescientistinJaynes’theory(Fiorillo2012;Phillips2012).
latedattheneuronalratherthanthesystemlevel,itmaybeposs-
...
“dark-room”
inference if taken as a single, multi-dimensional whole because correctly predicted directly solves the problem dis-
...
dividedintosmallsubsets,asamplyconfirmedbytheclearselec-
andcognition.Howcouldanyunifyingtheorycastlightonthat?
...
levels.Creationofthesubsetsinvolvesbothprespecifiedmechan-
arelargelyahopeforthefuture.CoherentInfomaxhypothesizes
isms,asinreceptivefieldselectivity,anddynamicgroupingaspro-
|     |     |     |     |     |     |     |     | a local building-block |     | from | which | endlessly | many | architectures |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------------------- | --- | ---- | ----- | --------- | ---- | ------------- | --- |
...
enceisagiven.Inthosemodels,itis–bythemodelers.Modelers
|     |     |     |     |     |     |     |     | have far-reaching |     | consequences |     | for philosophy, |     | and | human |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------------- | --- | ------------ | --- | --------------- | --- | --- | ----- |
...
| BI show | how       | to combine | information |           | from | different | sources     |     |     |     |     |     |     |     |     |
| ------- | --------- | ---------- | ----------- | --------- | ---- | --------- | ----------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
3G1,Canada.
| can coordinate |                            | their activities. |        | Thus,     | local selectivity, |              | dynamic-    |                       |                |            |                         |           |       |      |        |
| -------------- | -------------------------- | ----------------- | ------ | --------- | ------------------ | ------------ | ----------- | --------------------- | -------------- | ---------- | ----------------------- | --------- | ----- | ---- | ------ |
|                |                            |                   |        |           |                    |              |             | drasmuss@uwaterloo.ca |                |            | celiasmith@uwaterloo.ca |           |       |      |        |
| grouping,      | contextual-disambiguation, |                   |        |           | and                | coordinating | inter-      |                       |                |            |                         |           |       |      |        |
...
Clark’s a r c h it e c tu ra l a n d im p l e m e n t a ti on a l de ta il s n e e d ed t o fu lly in v es ti g a t e o r
|     | review, | however, | does | contain | the | essence | of an idea |                   |               |                |              |         | fi       |               |                  |
| --- | ------- | -------- | ---- | ------- | --- | ------- | ---------- | ----------------- | ------------- | -------------- | ------------ | ------- | -------- | ------------- | ---------------- |
|     |         |          |      |         |     |         |            | e v a lu a t e th | e i d e as it | p r e se n t s | . O n e w ay | t o b e | g i n to | ll in th e se | d e t a i ls i s |
...
| ------ | ----------- | ------ | --- | ------------ | ---------------- | --- | ------ | --- | --- | --- | --- | --- | --- | --- | --- |
Godisinthedetails
| actions | to implement | attention |     | (Feldman | &   | Friston | 2010), but |     |     |     |     |     |     |     |     |
| ------- | ------------ | --------- | --- | -------- | --- | ------- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
—MiesvanderRohe
...
—Anonymous
| them | as a function | of  | their predictive |     | relationships |     | and current |     |                                      |     |     |     |     |     |     |
| ---- | ------------- | --- | ---------------- | --- | ------------- | --- | ----------- | --- | ------------------------------------ | --- | --- | --- | --- | --- | --- |
...
statementsaretrue:thefirstisnotingthatdetailsareimportant,
|     |     |     |     |     |     |     |     |     | its representations). | Clark | claims that | the predictive | processing |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --------------------- | ----- | ----------- | -------------- | ---------- | --- |
difficult.
and the second that getting the details right is It is for framework differs from these structures in that it contains a
exactlythispairofreasonsthatwebelievethepredictiveproces- richer error signal (see Note 9 in the target article). However,
filter
singframeworkislimitedinitsabilitytocontribute,inadeepway, the Kalman is often employed in a multidimensional form
...
model’s
Craik devotes several chapters to his central hypothesis that: weight of the predictions versus the incoming infor-
“One
of the most fundamental properties of thought is its mation, but he does not indicate how that balance is to be
|     |     |     | events” |     |     |     |     |     |     |     |     |     |     | filters, |
| --- | --- | --- | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | -------- |
power of predicting (Craik 1943, p. 50). The evidence achieved. This is a well-studied problem in Kalman
specific
for prediction-related signals is strong, and the high-level where there are mechanisms to adjust these weights
models are often tantalizing. However, we (and, in our experi- depending on the measurement or estimate error (Brown &
specific
ence, most neuroscientists) want more: We want Hwang1992).Thus,itmaybepossibletoreplacethepoorlyspeci-
specific fiednotionof“attention”usedtocontroltheseweightsinthepre-
| neural | mechanismsthat |     | areemployed |     | in  |     | circumstances, |     |     |     |     |     |     |     |
| ------ | -------------- | --- | ----------- | --- | --- | --- | -------------- | --- | --- | --- | --- | --- | --- | --- |
well-defined
and we want to know how such models can be arranged to dictive processing framework (sect. 2.3) with
...
cessingframework“fail[s]tospecifytheoverallformofacogni- further–providing
|     |               |     |         |     |     |     |     |     | but we advocate | going |     | implementational |     |     |
| --- | ------------- | --- | ------- | --- | --- | --- | --- | --- | --------------- | ----- | --- | ---------------- | --- | --- |
|     | architecture” |     | “leaves |     |     |     |     |     |                 |       |     |                  |     |     |
tive and unanswered a wide range of details as well. For instance, there is more than one way to
implementaKalmanfilterinaspikingneuralnetwork(Eliasmith
| genuine | questions |     | concerning |     | the representational |     |     | formats |     |     |     |     |     |     |
| ------- | --------- | --- | ---------- | --- | -------------------- | --- | --- | ------- | --- | --- | --- | --- | --- | --- |
areas”
used by different brain (sect. 3.3, para. 4). The extent of &Anderson2003,Ch.9),eachofwhichhasdifferentimplications
framework’s
the predictive processing architectural claims is for the neurophysiological behavior of those networks. Once a
specified,
that the brain is organized in a hierarchical manner, with error neural implementation has been detailed comparisons
...
specific
interesting details: What is the form and function of cessingframeworkisunifying,theimplementationofsomesmall
...
flowing?
| expect | to  | see this | information |     |     | And, | more generally, |     | suchattempt). |     |     |     |     |     |
| ------ | --- | -------- | ----------- | --- | --- | ---- | --------------- | --- | ------------- | --- | --- | --- | --- | --- |
...
unspecified, filling-in detailorfirmarchitecturalcommitments,itisimpossibletodeter-
| these | details |     |     | but it | strikes | us that | the | of  |     |     |     |     |     |     |
| ----- | ------- | --- | --- | ------ | ------- | ------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
comewhentheyareusedtobuildamodelthatunifiesperception,
| It  | may seem | as  | if some | of these | questions | are | answered. | For |     |     |     |     |     |     |
| --- | -------- | --- | ------- | -------- | --------- | --- | --------- | --- | --- | --- | --- | --- | --- | --- |
instance,theprimarymethodofrepresentationinthebrainissup- cognition,andactioninasinglesystem.Suchaneffortwillrequire
adeeperinvestigationofthedetails,andeitherfilltheminwith
posedtobethroughprobabilitydensityfunctionsacrosstheposs-
ible states/concepts. However, as Clark mentions, these answers, or if answers are not to be found, require a reworking
“wide
representations could be implemented with a variety of of the theory. Either way, the predictive processing framework
|           |         |     |             |     | forms” |      |       |         | willbenefitenormouslyfromtheexercise. |     |     |     |     |     |
| --------- | ------- | --- | ----------- | --- | ------ | ---- | ----- | ------- | ------------------------------------- | --- | --- | --- | --- | --- |
| different | schemes |     | and surface |     | (sect. | 3.2, | para. | 4). For |                                       |     |     |     |     |     |
example,aprobabilitydensityp(x)couldberepresentedasahis-
NOTE
| togram    | (whichexplicitly |         | stores  | howmany |        | times   | each statex | has  |            |              |                   |           |         |        |
| --------- | ---------------- | ------- | ------- | ------- | ------ | ------- | ----------- | ---- | ---------- | ------------ | ----------------- | --------- | ------- | ------ |
|           |                  |         |         |         |        |         |             |      | 1. We have | in mind here | all the varieties | of Kalman | filters | (e.g., |
| occurred) |                  | or as a | summary | model   | (e.g., | storing | just the    | mean |            |              |                   |           |         |        |
...
|     |     |     |     |     |     |     |     |     | Interactively | human: | Sharing | time, |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ------------- | ------ | ------- | ----- | --- | --- |
culttoempiricallyevaluate.
Evenwhatseemstobethemostspecificclaimofthepredictive
|     |     |     |     |     |     |     |     |     | constructing | materiality |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ------------ | ----------- | --- | --- | --- | --- |
framework–that
| processing |                  |                  |        | there | exist            | functionally |            | distinct  |                               |     |     |     |     |     |
| ---------- | ---------------- | ---------------- | ------ | ----- | ---------------- | ------------ | ---------- | --------- | ----------------------------- | --- | --- | --- | --- | --- |
| “error”    |                  | “representation” |        |       |                  | brain–is     |            |           |                               |     |     |     |     |     |
|            | and              |                  |        | units | in the           |              | ambiguous. |           | doi:10.1017/S0140525X12002427 |     |     |     |     |     |
| Given      | multidimensional |                  | neuron |       | tuning (Townsend |              | et         | al. 2006; |                               |     |     |     |     |     |
AndreasRoepstorff
| Tudusciuc& |     | Nieder2009),unitscouldbesimultaneouslysensi- |     |     |     |     |     |     |     |     |     |     |     |     |
| ---------- | --- | -------------------------------------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| ----- | ---- | -------------- | --- | ------ | ---------- | ----- | --- | --------- | -------------------- | ---------- | ------ | ------------ | ------------- | --- |
|       |      |                |     |        |            |       |     |           | Abstract: Predictive | processing | models | of cognition | are promising | an  |
sub-populations.Again,thedetailsmatter.
Onewaytobegintofillinthemissingdetailsinthepredictive elegant way to unite action, perception, and learning. However, in the
species-unspecific
processingframeworkisbybeingmorespecificastowhatfunc- current formulations, they are and have very little
|     |     |     |     |     |     |     | filters1 |     | particularly human | about them. | I propose | to examine | how, | in this |
| --- | --- | --- | --- | --- | --- | --- | -------- | --- | ------------------ | ----------- | --------- | ---------- | ---- | ------- |
tions are computed. For example, Kalman (Kalman framework, humans can be able to massively interact and to build
...
|     |     |     |     | article’s |     |     |     |     |     | “we” |     |     |     |
| --- | --- | --- | --- | --------- | --- | --- | --- | --- | --- | ---- | --- | --- | --- |
some years, for all the reasons that the target review and that the dimensions of materiality can spin ourselves
identifies.
They propose to unify models of perception, action, into seem to be constantly changing. Humans appear to live
andlearningwithinaframework–whichiselegant,alignedwith possibilitiesforaction–andperhaps
liveswherebothpriorsand
|     |     |     | findings, |     |     |     |     | world–are |     |     |     |     |     |
| --- | --- | --- | --------- | --- | --- | --- | --- | --------- | --- | --- | --- | --- | --- |
neuroanatomical and functional computationally plaus- also, increasingly, the shaped by actions of others
ible, and able to generate empirical research with relatively and constrained, stabilised, and afforded by those structures
|     |     |     |     |     |     |     |     |     | “being | human” |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ------ | ------ | --- | --- | --- |
clearhypotheses. built in the process. But if in general is about
Sofartheideashavebeenawell-keptsecretwithinthecommu- livinginunfoldedpractices,what,then,isitaboutourcognition
nity.ThisBBSarticleislikelytochangethat.Asoneofthefirst, don’t
|     |     |     |     |     |     | that allows | us to | do that? | We  | know. | But something |     | about |
| --- | --- | --- | --- | --- | --- | ----------- | ----- | -------- | --- | ----- | ------------- | --- | ----- |
...
“linking
ical formality without losing out on the conceptual stringency, The predictive framework, in action, perception, and
learning,”
opens for a wider discussion of potential implications for how is highly relevant also to researchers outside of the
fillin
wethinkofthebrainandofourselves.Keytermslikeanticipation, neurosciences. But at this stage, there is much to for itto
...
tobegoodcandidatesforthenew“roughguide”tobrainfunction.
extendthistoageneralmodelofhumancognitionisimpressive,
butthisisalsowheretheproposalbecomesveryopen-ended.For, However,theseguidingprinciplesappeartoworkequallywellin
human-specific
ultimately, how is this predictive framework? In rats,inmacaques,andinhumans.Forthoseofuswhoareparticu-
the current formulation, hardly at all. The underlying neural larlyinterestedinwhathumansdotothemselves,toeachother,
species-unspecific,
models are basically and the empirical cases and to their world, there seem to be a lot of lacunae to be
filled.
move back and forth between many different model systems. explored, and a lot of gaps to be Getting these right may
...
relatestoaspecificunderstandingofhumanactionandcognition.
manydisciplines.
| To begin | this, one may | need | to ask what | is characteristic | of  |     |     |     |     |     |     |     |     |
| -------- | ------------- | ---- | ----------- | ----------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
don’t
| humans | as a life form? We |     | knowfor | sure, but | there are a |     |     |     |     |     |     |     |     |
| ------ | ------------------ | --- | ------- | --------- | ----------- | --- | --- | --- | --- | --- | --- | --- | --- |
interaction–
| few candidates. | One is | an unusual | ability | for |     |     |     |     |     |     |     |     |     |
| --------------- | ------ | ---------- | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
turns–at
| people coordinate, | couple,        | take          |      | many different | levels     |                 |     |            |     |            |     |     |     |
| ------------------ | -------------- | ------------- | ---- | -------------- | ---------- | --------------- | --- | ---------- | --- | ---------- | --- | --- | --- |
|                    |                |               |      |                |            | Action-oriented |     | predictive |     | processing |     | and | the |
| (Levinson          | 2006). Through | interactions, | they | come           | to share a |                 |     |            |     |            |     |     |     |
...
| -------- | ---------------- | -------- | ------------ | ------ | ------ | --- | --- | --- | --- | --- | --- | --- | --- |
DonRoss
Roepstorff2008):worldsthatexistoutsidetheindividual,andin
...
|     |     |     |     |     |     | Abstract: | Clark | expresses | reservations | about | Friston’s |     | reductive |
| --- | --- | --- | --- | --- | --- | --------- | ----- | --------- | ------------ | ----- | --------- | --- | --------- |
ings,buildingnichesthatarebothmaterialandcognitive,butthe
...
|     |     |     |     |     |     |               |     | doesn’t |      |       |              |     | specific |
| --- | --- | --- | --- | --- | --- | ------------- | --- | ------- | ---- | ----- | ------------ | --- | -------- |
|     |     |     |     |     |     | of cognition, | but | he      | link | these | reservations | to  |          |
...
| --- | --- | --- | --- | --- | --- | ----------- | ----- | --------- | --------- | ----------- | ----- | ------------- | --- |
interactions and the co-constructed shared worlds has been a error, are such an alternative. They interpret reward valuation as an
focus on human practices (Bourdieu 1977; Roepstorff et al. inputtoneocorticalprocessinginsteadofreducingit.
specific
| 2010) as | particular unfoldings |     | of temporality | set within |     |     |     |     |     |     |     |     |     |
| -------- | --------------------- | --- | -------------- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
specified
ticesmayhelpestablishpriorsorevenhyperpriors,setsofexpec- dence and speculations tethered to clearly models,
tationsthatshapeperceptionandguideaction(Roepstoff&Frith that action-oriented predictive processing (AOPP) accounts of
unified
2012).Followingfromthis,humanpriorsmaynotonlybedriven cortical activity offer the basis for a deeply account of
...
solidified
cated in interactions, mediated by representations, perception. And once one gets this far, it would be a strangely
...
|     |     | “predictive” |     |     | “situated” |     |     |     |     |     |     |     |     |
| --- | --- | ------------ | --- | --- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- |
This means that both the and the in tures his critical discussion around the most ambitious efforts
| Clark’s |     |     |     |     |     |     |     |     |     |     | unification |     | “all |
| ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----------- | --- | ---- |
title may get a radical twist. It is not so much a matter to use AOPP as the basis for a reductive of
|     | “socio-cultural |     | cocoon,” |     |     |     |     | organization” |     |     |     |     |     |
| --- | --------------- | --- | -------- | --- | --- | --- | --- | ------------- | --- | --- | --- | --- | --- |
of living inside a as Clark puts it (sect. elements of systemic in the brain (sect. 1.6, para.
...
alsonotjustamatterof“man”as“ananimalsuspendedinwebs amplifies
|     |     |     |     |     |     | strong, | over-arching | hypothesis. |     | My  | commentary |     |     |
| --- | --- | --- | --- | --- | --- | ------- | ------------ | ----------- | --- | --- | ---------- | --- | --- |
ofsignificancehehimselfhasspun,”asCliffordGeertz(1966),fol-
|     |     |     |     |     |     | some of | these reservations, |     | based | on  | neglect | of the | role of |
| --- | --- | --- | --- | --- | --- | ------- | ------------------- | --- | ----- | --- | ------- | ------ | ------- |
...
webs“we”have
| see that | the | spun | areindeedalso | verymaterial, |     | processing. |                                      |     |     |     |     |     |     |
| -------- | --- | ---- | ------------- | ------------- | --- | ----------- | ------------------------------------ | --- | --- | --- | --- | --- | --- |
|          |     |      |               |               |     |             | BEHAVIORALANDBRAINSCIENCES(2013)36:3 |     |     |     |     |     | 45  |

Commentary/Andy Clark: Predictivebrains,situated agents,and thefutureof cognitive science
Clark’s
survey is notable for the absence of any discussion of generalcognition,allowsustostraightforwardlymodelthediscon-
|     |     |     |     |     |     |     |     |     | identifies |     |     |     | (“surprisal”) |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | ---------- | --- | --- | --- | ------------- | --- |
relative reward-value computation. Studies of such valuation nect Clark between surprise to the brain
andsurprisetotheagent.Clark’sexampleisofasurprise-minimiz-
| based on | single-cell | recordings | in  | rat striatum | were | the | original |     |     |     |     |     |     |     |
| -------- | ----------- | ---------- | --- | ------------ | ---- | --- | -------- | --- | --- | --- | --- | --- | --- | --- |
...
Thesuggestionhereisthatneuroeconomicsisoneresource–of
toprovideageneralaccountofmammaliancognition.However,
others–for
neuroeconomists have subsequently embedded TD learning in course we should expect there to be addressing
|     |     |     |     |     |     |     |     | Clark’s | “even |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ------- | ----- | --- | --- | --- | --- | --- |
modelsof widerscopethat exploit driftdiffusionand meta-con- concern that taken together, the mathematical
...
| ton’s |     | “looks |     |     |     |     |     |     |     | areas” |     |     |     |     |
| ----- | --- | ------ | --- | --- | --- | --- | --- | --- | --- | ------ | --- | --- | --- | --- |
most recent work to involve a strong commitment multiple cortical and subcortical (sect. 3.3, para. 4). But
…
...
|     |     |     |     |     | …   |     | action” |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- | --- | --- |
as determinants of action, with expectations about inunderstandingsub-cognitivevaluationasaninputtocognition,
(seeNote12inthetargetarticle). ratherthanassomethingthatamodelofcognitiveactivityshould
Onetheorist’seliminationisfrequentlyanothertheorist’scon-
reduceaway.
...
|                    |     |                  |     |         |     |              |     | predictive | processing      | in              | musical | behaviour |     |     |
withreward,explainingbothasfunctionalproductsofthepredic-
...
RebeccaS.Schaefer,KatieOvery,andPeterNelson
| direct dopaminergic/striatal |     |     | signaling | to  | motor | preparation |     |     |     |     |     |     |     |     |
| ---------------------------- | --- | --- | --------- | --- | ----- | ----------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
Glimcher’s
preoccupation. More basically, (2003) proposal to research/imhsd/imhsd-home
| model some | neural | response | using | economics |     | was originally |     |     |     |     |     |     |     |     |
| ---------- | ------ | -------- | ----- | --------- | --- | -------------- | --- | --- | --- | --- | --- | --- | --- | --- |
Abstract:Theimportantrolesofpredictionandpriorexperiencearewell
motivatedbyobservationsofactivityincellsthatcontroleyesac- establishedinmusicresearchandfitwellwithClark’sconceptofunified
...
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | -------------------- | -------- | --- | ------------- | --- | ----- |
Thisintegrationofattentionandneurallearningwithactionis musical intelligence, Clark needs to further consider the powerful and
...
notjustaboutthequantityoferrorbut…aboutthemismatched
|     |     |     |     |     |     |     |     | The roles | of prediction, | expectation, | and | prior | experience | in  |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | -------------- | ------------ | --- | ----- | ---------- | --- |
contentitself,”asClarksays(Note9ofthetargetarticle).
|     |     |     |     |     |     |     |     | musical processing | are well | established |     | (Huron | 2006; | Large |
| --- | --- | --- | --- | --- | --- | --- | --- | ------------------ | -------- | ----------- | --- | ------ | ----- | ----- |
So far, we might seem to have only a semantic difference et al. 2002; Meyer 1956; Narmour 1990; Phillips-Silver &
Friston’s
between neuroeconomics and radical interpretation of Trainor 2008; Vuust & Frith 2008), and indeed have led to the
...
| reflect |     |     |     |     | doesn’t |     |     |     |     |     |     |     |     |     |
| ------- | --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
which worries that Clark notes but connect with Bayesian models have been shown to account for a range of
...
Friston’ssuggestioninresponsethat“somespeciesareequipped
|     |     |     |     |     |     |     |     | during auditory | rhythm perception |     | (e.g., | Grahn | & Brett | 2007), |
| --- | --- | --- | --- | --- | --- | --- | --- | --------------- | ----------------- | --- | ------ | ----- | ------- | ------ |
with prior expectations that they will engage in exploratory or andthatmusicalimageryevokessimilarneuralresponsesasper-
play” ception(Schaeferetal.2011a;2011b).Clark’sunifiedframework
| social | (Friston | 2011a; | see sect. | 3.2, | para. 2, | in the | target |     |     |     |     |     |     |     |
| ------ | -------- | ------ | --------- | ---- | -------- | ------ | ------ | --- | --- | --- | --- | --- | --- | --- |
...
bestexplanationsconditionalonone’shypothesis.Theneuroeco-
However,thecurrentaccountdoesnotattempttodealwiththe
nomicmodelofstriatalvaluationmakesthispositunnecessary–
rangeofwaysinwhichpredictionerrorinducesarousalandaffect.
or,onanotherphilosophicalinterpretation,replacesthedubious Theextenttowhichourpredictionsaremetorviolated,histori-
IBEbyevidenceforamechanism–bysuggestingthatdiscovery
|     |     |     |     |     |     |     |     | cally theorized | to lead to | an arousal | response | (Berlyne |     | 1970), |
| --- | --- | --- | --- | --- | --- | --- | --- | --------------- | ---------- | ---------- | -------- | -------- | --- | ------ |
...
specific
closely coupled to the characteristics of that musical organizationandself-expression(Nelson2012)withanemphasis
on“error”aspositive,meaningfulinformation.
featureorbehaviour.AsClarkstates,contextsensitivityisfunda-
...
flexible;
| more | but | drumming | usually | involves | strict | timing | con- |     |     |     |     |     |     |
| ---- | --- | -------- | ------- | -------- | ------ | ------ | ---- | --- | --- | --- | --- | --- | --- |
flexibility
straints, with more in terms of pitch. Our perceptual Extending predictive processing to the body:
finely
systems are attuned to these constraints, to the point that Emotion as interoceptive inference
fit
| rhythmic | deviations | that | with | certain | aspects | of perceived |     |     |     |     |     |     |     |
| -------- | ---------- | ---- | ---- | ------- | ------- | ------------ | --- | --- | --- | --- | --- | --- | --- |
...
specific
This tuning of our perceptual system to deviations aSacklerCentreforConsciousnessScience,UniversityofSussex,Brighton
...
“play”
musical styles require and indeed with levels of surprisal a.k.seth@sussex.ac.uk H.Critchley@bsms.ac.uk
...
| ------------------ | ------------- | ----------- | -------------- | -------- | ----------- | ---------- | -------- | --------------------------------------------------------------- | ------------------------- | ---------- | -------------- | ------- | ------------------------- |
|                    |               |             |                |          |             | Proficient |          | Abstract:TheBayesianbrainhypothesisprovidesanattractiveunifying |                           |            |                |         |                           |
| to the complex     |               | polyrhythms | of             | African  | percussion. |            |          |                                                                 |                           |            |                |         |                           |
|                    |               |             |                |          |             |            |          | framework                                                       | for perception,           | cognition, | and            | action. | We argue that the         |
| musicians          | and composers |             | are implicitly | aware    | of          | these      | effects, |                                                                 |                           |            |                |         |                           |
...
|                    |               |             |                |          |             | “          |          | t h e i n te r n                                                | a l p h y s io lo g i cal | co n d     | iti o n o f    | th e bo | d y . O u r m o d e l o f |
o f th e l is t e n e r. T h is le a d s to w h at h a s b e e n c oi n e d co m m u n i c a - “ ”
” in ter o c e p ti v e p r e d ic ti v e cod in g e n tai ls a n ew v i e w o f em o t io n as
t i ve p r e s s u re i n c re at i n g m us ic ( T e m p e r le y 2 0 0 4) : a n im p l i c i t interoceptive inference and may account for a range of psychiatric
...
“viewfrominsidetheblackbox,”thenotionthatthebrainmust
| to note | that different |     | musical | environments |     | have different |     |     |     |     |     |     |     |
| ------- | -------------- | --- | ------- | ------------ | --- | -------------- | --- | --- | --- | --- | --- | --- | --- |
...
influence
response. Indeed, exposure has been shown to liking between brain and (external) world. Perhaps underemphasized
...
finding selfarise.However,thebrain’saccesstothefactsofitsembodi-
| exposure | (Loui | et al. 2010). | This |       | supports | the idea | of a |     |     |     |     |     |     |
| -------- | ----- | ------------- | ---- | ----- | -------- | -------- | ---- | --- | --- | --- | --- | --- | --- |
|          |       | configuration |      | one’s |          |          |      |     |     |     |     |     |     |
strong personalized of own preference for ment and of its physiological milieu is arguably just as indirect
|     |     | reflected |     |     |     |     |     |     |     |     |     |     | Clark’s |
| --- | --- | --------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ------- |
unpredictability, in musical likes and dislikes, as well as its access to the surrounding world. Here, we extend
| one’s |     |     |     |     |     |     |     |     |     |     |     | interoception–the |     |
| ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ----------------- | --- |
as own prediction abilities, shown to be quite stable over integrative analysis by proposing that sense
ofthephysiologicalconditionofthebody(seeCraig2003)–can
| time per | individual, |     | affecting | interpersonal |     | coordination |     |     |     |     |     |     |     |
| -------- | ----------- | --- | --------- | ------------- | --- | ------------ | --- | --- | --- | --- | --- | --- | --- |
(Pecenka & Keller 2011). An individual personality might be alsobeusefullyconsideredfromtheperspectiveofpredictivepro-
cessing.Ourmodelof“interoceptivepredictivecoding”(Critchley
| thrill-seeking | and | seek | out highly | unpredictable |     | new | musical |     |     |     |     |     |     |
| -------------- | --- | ---- | ---------- | ------------- | --- | --- | ------- | --- | --- | --- | --- | --- | --- |
...
influential
thesurprisalresponseisnon-uniformformusic:Thepositioning more than a century later, underpinning frameworks
ofacurvedescribing“optimalsurprisal”foraffectiveoraesthetic
forunderstandingemotionanditsneuralsubstrates,suchasthe
|     |     |     |     |     |     |     |     | “somatic | hypothesis” |     |     |     | “sentient |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | ----------- | --- | --- | --- | --------- |
reward will be determined by culture, training, or musical style, marker (Damasio 2000) and the
|                 |       |        |           |     | specific |        |      | self”model(Craig2009),bothlinkedtothenotionof“interocep- |                |     |              |     |     |
| --------------- | ----- | ------ | --------- | --- | -------- | ------ | ---- | -------------------------------------------------------- | -------------- | --- | ------------ | --- | --- |
| and its precise | shape | (e.g., | kurtosis) | may | be       | to the | type |                                                          |                |     |              |     |     |
|                 |       |        |           |     |          |        |      | awareness”                                               | “interoceptive |     | sensitivity” |     |     |
andlevelofthepredictionormentalmodel.Andwhilethecharac- tive or (Critchley et al.
...
“feedforward”
major part in what makes prediction error in music (large or along lines, similar to classical feature-detection
...
influencesubjectivefeelingstatesandemotionalbehaviour.Fifty
theaffectiveresponsetothepredictionerrorthatgivestheinitial
...
|     |     |     |     |     |     |     |     |     |     |     |     | “two | factor” |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | ---- | ------- |
predictabilitywillrequirediscussionelsewhere,butwepostulate This observation was formalized in their theory, in
...
Commentary/Andy Clark: Predictive brains, situated agents, and thefuture ofcognitivescience
finding
computational principle is the that it can be the basis of in a darkened room will be entirely ineffective in reducing such
...
cifiesafinaloutcome.Manyvariationsinthetrajectoryareirrele-
|     |     |     |     |     |     |     |     | agent must | act | so as to | change the | sensory | feedback |     | (i.e., to |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | --- | -------- | ---------- | ------- | -------- | --- | --------- |
final
vant to achieving the goal (Todorov & Jordan 2002), a increase the level of sugar in the blood). This answer is comp-
lementarytoClark’sobservationthatsomeformsofpriorexpec-
| redundancy | that | is absent |     | from the | perceptual | inference |     |     |     |     |     |     |     |     |     |
| ---------- | ---- | --------- | --- | -------- | ---------- | --------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|     |     |     | “deep | unity” |     |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | ----- | ------ | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
Clark emphasises the between the two tasks, exploitativeactions(whichcan,inanyevent,onlybedrawnrela-
whichisjustifiedbutmightservetoobscureanimportantdiffer-
tivetosomesetofgoalstates).
Afinalobservationconcernsthequestionofwhethertheexpec-
ence.Intheperceptualtask,apredictionerrorisusedtochange
...
Toconclude,Clark’spersuasivecasefortheimportanceofpre-
| those computations |     | are | deployed | quite | differently | in the | two |     |     |     |     |     |     |     |     |
| ------------------ | --- | --- | -------- | ----- | ----------- | ------ | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
phershavecalleddifferent“directionsoffit.”Amotortasktakes
|     |     |     |     |     |     |     |     | ful research | agenda, | brings | new issues | into | focus. | An important |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ------------ | ------- | ------ | ---------- | ---- | ------ | ------------ | --- |
fixed;
as input a goal state, which is held a motor program to one is the question of what makes that computational principle
attain that goal state is then calculated (Todorov 2004). These operateinindicative(perceptual)modeinsomesubsystemsand
fit
goal states have a world-to-mind direction of and imperative inimperative(action)modeinothers.
...
|     |     |     |     |     |     |     |     | challenge | prediction |     | error | as  | the basis | of  |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | ---------- | --- | ----- | --- | --------- | --- | --- |
initsconsequencesforthebehaviouroftheorganism:Prediction
...
|                                                          |                                              |     |     |     |     |     |     | Abstract:           | There | are aspects | of schizophrenia |     | that pose | challenges | for |
1998),butthepredictivecodingframeworkonitsowndoesnot.
|     |     |     |     |     |     |     |     | Clark’s model. | These | include: | (1) | evidence | for excitatory |     | activity |
| --- | --- | --- | --- | --- | --- | --- | --- | -------------- | ----- | -------- | --- | -------- | -------------- | --- | -------- |
(Itdoes,however,undermineaclearboundarybetweenperception
...
| --- | --- | --- | --- | --- | --- | --- | --- | -------------- | ---- | ------- | -------- | ------- | ------------ | ---------- | --- |
diction/expectation is given a mind-to-world functional role, error;and(3)thecriticalroleofemotionalfactorsas settingconditions
...
| ---------- | ----- | ------------ | --- | --------------- | --- | ---------- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
Clark’smodelemphasizestheprocessingofpredictionerror,and,
| such that | prediction | errors | cause | bodily | movements/action? |     | As  |     |     |     |     |     |     |     |     |
| --------- | ---------- | ------ | ----- | ------ | ----------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
|       |         |             |     |            |         | “desert |       | stratingthatClark’sview,atpresent,doesnotprovideafullyade- |     |     |     |     |     |     |     |
| ----- | ------- | ----------- | --- | ---------- | ------- | ------- | ----- | ---------------------------------------------------------- | --- | --- | --- | --- | --- | --- | --- |
| Clark | goes on | to consider |     | whether an | austere |         | land- |                                                            |     |     |     |     |     |     |     |
scape”
description of the computational processing is possible quateheuristicforunderstandingpsychoticphenomena.
Clark’s
that does away with goals and reward entirely (sect. 5.1), in the theory emphasizes anti-Hebbian feedforward proces-
...
fit,
dance requires states with a world-to-mind direction of then presumably because no deviation from what is expected is
...
|     |     |     |     |     |     | don’t |     |     |     |     | significance. |     |     |     |     |
| --- | --- | --- | --- | --- | --- | ----- | --- | --- | --- | --- | ------------- | --- | --- | --- | --- |
throws light on the darkened room problem: Why agents thereby signaling stimulus Numerous demon-
...
eachotherinadefinitivestudy.
ithasbeensuggested,duetothehighprevalenceofhistoriesof
ConsistentwithClark’sview,evidenceexiststhat,forexample,
childhoodphysicalandsexualabuseinpeoplewithschizophrenia
...
|     |     | Clark’s |     |     |     | Weber’s |     |     |     |     |     |     |
| --- | --- | ------- | --- | --- | --- | ------- | --- | --- | --- | --- | --- | --- |
stein et al. 2009). view is also consistent with other aspects of the memory trace due to hippocampal impair-
(2002) view that much of our direct understanding of visual ment secondary to chronic cortisol production (Read et al.
|     |     |     | “metamorphoses |     | geometry” |     |     |     |     |     |     |     |
| --- | --- | --- | -------------- | --- | --------- | --- | --- | --- | --- | --- | --- | --- |
forms results from perception of of 2001) (as opposed to being due to top-down expectancy driven
ortopological(isotopic)alterationsofbasicforms,aviewconsist- processing). A purely computational theory of hallucinations
music–it
entwithevidencethattopologicalinvariantsaretheprimitivesto and/or delusions is like a mathematical theory of can
...
Clark’s
| Silverstein | & Keane | 2011). A | challenge | for | view | is to |     |     |     |     |     |     |
| ----------- | ------- | -------- | --------- | --- | ---- | ----- | --- | --- | --- | --- | --- | --- |
AaronSloman
accountforthesephenomena,whichhavebeenpreviouslyunder-
reflecting
stood as a breakdown in Hebbian processing, and SchoolofComputerScience,UniversityofBirmingham,BirminghamB152TT
| reduced | self-organization | at  | the local | circuit | level, | involving | UnitedKingdom. |     |     |     |     |     |
| ------- | ----------------- | --- | --------- | ------- | ------ | --------- | -------------- | --- | --- | --- | --- | --- |
http://www.cs.bham.ac.uk/∼axs
reducedlateral(andre-entrant)excitation. a.sloman@cs.bham.ac.uk
Clarknotesthatwhileperceptualanomaliesalonewillnottypi-
|            |               |                 |           |              |            |         | Abstract:    | The approach         | Clark labels | “action-oriented |        | predictive       |
| ---------- | ------------- | --------------- | --------- | ------------ | ---------- | ------- | ------------ | -------------------- | ------------ | ---------------- | ------ | ---------------- |
| cally lead | to delusions, | the perceptual  |           | and doxastic | components |         |              |                      |              |                  |        |                  |
|            |               |                 |           |              |            |         | processing”  | treats all cognition | as part      | of a system      | of     | on-line control. |
| should not | be seen       | as independent. | However,  |              | there are  | several |              |                      |              |                  |        |                  |
|            |               |                 |           |              |            |         | This ignores | other important      | aspects      | of animal,       | human, | and robot        |
| syndromes  | (e.g.,        | Charles Bonnet  | Syndrome, |              | Dementia   | with    |              |                      |              | “                |        | ”                |
LewyBodies,Parkinson’sDiseaseDementia)wherevisualhallu- i n t ell i g e n c e . H e co n t r as t s it w it h an al le g e d m a in s t r e a m a pp r o a c h th a t
’
|     |     |     |     |     |     |     | a ls o i g n o r e | s t he d e p t h a n d v ar | i ety of A | I / R ob o ti | c r e s e a r ch | . I d o n t th in k |
| --- | --- | --- | --- | --- | --- | --- | ------------------ | --------------------------- | ---------- | ------------- | ---------------- | ------------------- |
cinationsareprominentanddelusionsaretypicallyabsent(Sant- thetheorypresentedisworthtakingseriouslyasacompletemodel,even
difficult
house et al. 2000). Moreover, it would appear to be to ifthereismuchthatitexplains.
explainthewell-formedhallucinationscharacteristicofthesesyn-
Clark’spaperdeservesfarmorethan1,000words,butIhaveto
| dromes as | being due | to prediction | error, | given | their sometimes |     |     |     |     |     |     |     |
| --------- | --------- | ------------- | ------ | ----- | --------------- | --- | --- | --- | --- | --- | --- | --- |
...
opment,1includingmathematicaldiscoveryandreasoning,using
| Howard | 1999; Geldmacher | 2003) |     | that argue | against | Bayes- |     |     |     |     |     |     |
| ------ | ---------------- | ----- | --- | ---------- | ------- | ------ | --- | --- | --- | --- | --- | --- |
optimal perception in these cases. There are also many cases of evolved mechanisms (perhaps) shared by several species
capableofthe“representationalredescription”postulatedinKar-
schizophreniawheredelusionsarepresentwithouthallucinations.
meta-configured
Finally,whileevidenceofreducedbinoculardepthinversionillu- miloff-Smith (1992) and the competences
sionsinschizophrenia(Keaneetal.,inpress;Koetheetal.2009) suggestedinChappell&Sloman(2007),including(largelyunstu-
providesevidence,ontheonehand,foraweakenedinfluenceof “toddler theorems”
|     |     |     |     |     |     |     | died) discoveries | of  |             |     | (Sloman | 2010). The |
| --- | --- | --- | --- | --- | --- | --- | ----------------- | --- | ----------- | --- | ------- | ---------- |
|     |     |     |     |     |     |     | “action-oriented  |     | processing” |     |         |            |
priors(orofthelikelihoodfunction)(Phillips2012)onperception, predictive approach treats every-
“enactivist”
this evidence also indicates more veridical perception of the thing as on-line control (Powers 1973), like theorists
...
sufficient
degree, resulting in a lack of top-down modulation, etc.), preferences, explanations, theories, arguments, story plots,
and bottom-up (but not error) signals being strengthened. formsofrepresentation,ontologies,grammars,andproofs.Predic-
doesn’t
Indeed, this is exactly what was demonstrated in recent studies tive processing explain termite cathedral building.
...
| theenvironmentasawhole,andoftheself–which,inturn,can |     |     |     |     |     |     |          |               | That’s |          |       |          |
| ---------------------------------------------------- | --- | --- | --- | --- | --- | --- | -------- | ------------- | ------ | -------- | ----- | -------- |
|                                                      |     |     |     |     |     |     | extended | environments. | not    | learning | about | mappings |
It’s
spawndelusions(Mattusek1987;Sass1992;Uhlhaas&Mishara between inputs and outputs. a special case of using actions,
...
| thedelusion. |     |     |     |     |     |     | valency. |     |     |     |     |     |
| ------------ | --- | --- | --- | --- | --- | --- | -------- | --- | --- | --- | --- | --- |
Finally,Clark’sviewofhallucinationsissimilartomanymodels
|     |     |     |     |     |     |     | Systematically | varying | how things | are | squeezed, | stroked, |
| --- | --- | --- | --- | --- | --- | --- | -------------- | ------- | ---------- | --- | --------- | -------- |
...
configurations
ationsonly.But,asnoted,delusionsoftengrowoutofphenomen- kinds of matter, and different spatial and pro-
...
“off-line”
more on aspects of intelligence ignored by many with other information processing systems: predators, prey, and
| “enactivist” |     | “embodied | cognition” |     |     |     | conspecifics |     |     |     |     |     |     |     |     |
| ------------ | --- | --------- | ---------- | --- | --- | --- | ------------ | --- | --- | --- | --- | --- | --- | --- | --- |
and enthusiasts, see Sloman (young and old). Generalizing Turing (1952), I call
thisthe“Meta-morphogenesisproject”(Sloman2013).
| (1996; 2006; | 2009). | Even | for on-line |     | control, | the use of | servo- |     |     |     |     |     |     |     |     |
| ------------ | ------ | ---- | ----------- | --- | -------- | ---------- | ------ | --- | --- | --- | --- | --- | --- | --- | --- |
modifications Clarkcomparestheprediction“story”with“mainstreamcom-
| control | with qualitative |     |     |     | of behavior | responding |     |     |     |     |     |     |     |     |     |
| ------- | ---------------- | --- | --- | --- | ----------- | ---------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
biasing)”
tion: Head for the center of the gap, then as you get close feature detection (perhaps with some top-down (sect.
5.1).ThisfitssomeAIresearch,butlabellingitas“mainstream”
| use vision | or touch | to  | control | your | heading. | Choosing | a   |     |     |     |     |     |     |     |     |
| ---------- | -------- | --- | ------- | ---- | -------- | -------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
reflex
action. approaches and techniques including constraint-processing,
...
scientific
| example | most deep |     | predictions, |     | or a | prediction | that a tigatedinrobotics. |     |     |     |     |     |     |     |     |
| ------- | --------- | --- | ------------ | --- | ---- | ---------- | ------------------------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
flaw
understand the in a philosophical argument, or just day- turedwindowmovingupanddown.
“hierarchical
dreamingaboutaninter-planetaryjourney. Clark claims (in his abstract) that the prediction
Idon’tdenythatmanycognitiveprocessesinvolvemixturesof machine” “offers
|     |     |     |     |     |            |     |         |     | approach |     | the best | clue | yet to | the shape | of a |
| --- | --- | --- | --- | --- | ---------- | --- | ------- | --- | -------- | --- | -------- | ---- | ------ | --------- | ---- |
|     |     |     |     |     | influence: |     | unified |     |          |     | action”. |      |        | unifies   |      |
top-down, bottom-up, middle-out (etc.) I helped science of mind and But it only the
...
NOTE
linecontrol(Sloman1982;1989).DavidHogg,thenmystudent,
|     |     |     |     |     |     |     | 1.  | For more | details, | see http://www.cs.bham.ac.uk/research/projects/ |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | -------- | -------- | ----------------------------------------------- | --- | --- | --- | --- | --- |
used3-Dpredictiontoreducevisualsearchintrackingahuman
cogaff/12.html#1203.
...
|           |                 |          |                  |     |             |                | Distinguishing |     |     | theory | from | implementation |     |     | in  |
| assemble  | and instantiate |          | multi-layered    |     | percepts    | of structures  |                |     |     |        |      |                |     |     |     |
...
| -------- | --------- | -------- | ------- | --- | ------ | ----------- | ----- | --- | --- | --- | --- | --- | --- | --- | --- |
difficult,
will be but not impossible. Constraint propagation doi:10.1017/S0140525X12002178
...
box”
| is one such                    | black       | (sect.     | 1.2). | This     | sounds    | like a variant | of             |          |               |          |                |                |         |          |          |
| ------------------------------ | ----------- | ---------- | ----- | -------- | --------- | -------------- | -------------- | -------- | ------------- | -------- | -------------- | -------------- | ------- | -------- | -------- |
|                                |             |            |       |          |           |                | Abstract:      |          | It is often   | helpful  | to distinguish |                | between | a theory | (Marr’s  |
| concept                        | empiricism, | defeated   |       | long ago | by Kant   | (1781)         | and            |          |               |          |                |                |         |          |          |
|                                |             |            |       |          |           |                | computational  |          | level)        | and a    | specific       | implementation |         | of that  | theory   |
| buriedbyphilosophersofscience. |             |            |       |          |           |                | (Marr’s        |          |               |          |                |                |         |          |          |
|                                |             |            |       |          |           |                |                | physical | level).       | However, |                | in the         | target  | article, | a single |
...
| --- | --- | --- | --- | --- | --- | --- | ------ | ------------- | --- | -------------- | ----- | --------------- | --- | --- | ---------- |
isms, are not concerned merely with predicting and controlling coding have been formulated which can explain additional
...
sortofexplorationof“designspace”and“nichespace”formany
|     |     |     |     |     |     |     | Similarly, |     | each population |     | of error-detecting |     | neurons | also | sends |
| --- | --- | --- | --- | --- | --- | --- | ---------- | --- | --------------- | --- | ------------------ | --- | ------- | ---- | ----- |
...
(seesects.1.1and2.1)thatinPCthefeedforwardflowofinfor-
stance(McCarthy2008)tospeculateabouttestablemechanisms.
|     |     |     | “just | so” |     |     |     |     |     |     |     |     |     |     |     |
| --- | --- | --- | ----- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
(It is a mistake to disparage stories based on deep mation solely conveys prediction error, while feedback only
...
mationflowinthereversedirectionstakesplacewithineachcor-
implementationofPC(Rao&Ballard1999);ortherangeofatten-
...
|         |     |     |     |     |     |     |     |                 |     | firing |          |       |          | defined |     |
| ------- | --- | --- | --- | --- | --- | --- | --- | --------------- | --- | ------ | -------- | ----- | -------- | ------- | --- |
| 2008b). |     |     |     |     |     |     |     | employ negative |     | rates. | However, | PC/BC | is still |         | at  |
...
ficialcorticallayers,arenotpredictionsofPCingeneral,butpre-
alternativetheoriesofbrainfunction,suchasdivisivenormalisa-
specific
dictions of one implementation of PC. These claims, tion and biased competition (Spratling 2008a; 2008b). Other
falsifiable
therefore, do not constitute predictions of PC (if they implementations of PC may in future prove to be even better
didthentheideathatPCoperatesintheretina–asdiscussedin
|     |     |     |     |     |     |     |     | models of | brain | function, | which | is even | more | reason | not to |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | ----- | --------- | ----- | ------- | ---- | ------ | ------ |
sect.1.3–couldberejected,duetothelackofcorticalpyramidal
|                                                              |     |     |     |     |     |     |     | confuse       | one particular | implementation |     |     | of a theory | with | the |
| ------------------------------------------------------------ | --- | --- | --- | --- | --- | --- | --- | ------------- | -------------- | -------------- | --- | --- | ----------- | ---- | --- |
| cellsinretinalcircuitry!).Indeed,itishighlydoubtfulthatthese |     |     |     |     |     |     |     | theoryitself. |                |                |     |     |             |      |     |
falsifiable
| claims even | constitute |     |     | predictions |     | of the | standard |     |     |     |     |     |     |     |     |
| ----------- | ---------- | --- | --- | ----------- | --- | ------ | -------- | --- | --- | --- | --- | --- | --- | --- | --- |
defined
| implementation  |                | of PC.        | The standard | implementation   |                | is            |          |                               |        |       |            |     |              |     |     |
| --------------- | -------------- | ------------- | ------------ | ---------------- | -------------- | ------------- | -------- | ----------------------------- | ------ | ----- | ---------- | --- | ------------ | --- | --- |
...
|                 |                |               |              |                  |                | firing        |          | Sparse                        | coding | and   | challenges |     | for Bayesian |     |     |
| can generate    |                | both positive |              | and negative     |                | rates.        | The      |                               |        |       |            |     |              |     |     |
|                 |                |               |              |                  |                |               |          | models                        | of the | brain |            |     |              |     |     |
| mapping         | between        | elements      | of           | the standard     | implementation |               | of       |                               |        |       |            |     |              |     |     |
| PC and          | elements       | of cortical   | circuitry    | may,             | therefore,     | be            | far less |                               |        |       |            |     |              |     |     |
|                 |                |               |              |                  |                | superficial   |          | doi:10.1017/S0140525X12002300 |        |       |            |     |              |     |     |
| direct than     | is suggested   |               | by the       | claim about      | deep           | and           |          |                               |        |       |            |     |              |     |     |
| layer pyramidal |                | cells.        | For example, |                  | the role       | of prediction |          |                               |        |       |            |     |              |     |     |
ThomasTrappenbergandPaulHollensen
| neurons | and/or | error-detecting |     | neurons | in the | model | might be |     |     |     |     |     |     |     |     |
| ------- | ------ | --------------- | --- | ------- | ------ | ----- | -------- | --- | --- | --- | --- | --- | --- | --- | --- |
performed by more complex cortical circuitry made up of FacultyofComputerScience,DalhousieUniversity,Halifax,NSB3H4R2,
Canada.
| diverse populations |     | of        | neurons, | none   | of which | behave | like the |              |                         |     |     |     |     |     |     |
| ------------------- | --- | --------- | -------- | ------ | -------- | ------ | -------- | ------------ | ----------------------- | --- | --- | --- | --- | --- | --- |
|                     |     |           |          |        |          |        |          | tt@cs.dal.ca | paulhollensen@gmail.com |     |     |     |     |     |     |
| model neurons       |     | but whose | combined | action | results  | in     | the same |              |                         |     |     |     |     |     |     |
www.cs.dal.ca/∼tt
computationbeingperformed.
ThefactthatPCistypicallyimplementedatalevelofabstrac-
|     |     |     |     |     |     |     |     | Abstract: | While | the target article | provides | a   | glowing | account | for the |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | ----- | ------------------ | -------- | --- | ------- | ------- | ------- |
tion that is intermediate between that of low-level, biophysical, excitementinthefield,westressthathierarchicalpredictivelearningin
...
virtue.Suchintermediate-levelmodelscanidentifycommoncom- the relation between Bayesian cognitive processes and hierarchical
...
Clark’s
lips & Singer 1997); they seek integrative explanations that are target article captures well our excitement about predic-
...
findings
empiricaldatathatarearguablythemostrelevanttoneuroscience tational learning to match biological that has not been
...
Bayes’
theorem states that the posterior is proportional to the quantifyingthegeneralapproach.
...
Field(1996),thecorrespondingfiltersdonotresemblereceptive
| probabilistic   | respectability |     | while | employing |     | mechanisms | to  |        |     |     |     |     |     |     |     |
| --------------- | -------------- | --- | ----- | --------- | --- | ---------- | --- | ------ | --- | --- | --- | --- | --- | --- | --- |
| “probabilities” |                |     |       |           |     |            |     | fields |     |     |     |     |     |     |     |
derive that are as ad-hoc and unprincipled as the in the brain. In contrast, if a generative model has the
non-Bayesian models they claim superiority over. It can be additional constraint to minimize not only the reconstruction
hopedthatPCwillprovideaframeworkwithsufficientconstraints
|     |     |     |     |     |     |     |     | error but | also the | number  | of basis | functions | that | are used | for |
| --- | --- | --- | --- | --- | --- | --- | --- | --------- | -------- | ------- | -------- | --------- | ---- | -------- | --- |
|     |     |     |     |     |     |     |     | specific  |          | filters |          |           |      |          |     |
to allow principled models of hierarchical Bayesian inference to any image, then emerge that resemble receptive
fieldsofsimplecellsintheprimaryvisualcortex.
bederived.
final Sparserepresentationintheneuroscientificcontextactuallyhas
| A   | point | about different |     | implementations |     | is that | they are |     |     |     |     |     |     |     |     |
| --- | ----- | --------------- | --- | --------------- | --- | ------- | -------- | --- | --- | --- | --- | --- | --- | --- | --- |
...
first
implement the theory using different mathematical operations. representations (Barlow 1961), and probably the systematic
...
fields
sparseness constraint can reproduce receptive resembling are Bayesian in the sense that they represent causal models
simple cells (Saxe et al. 2011), and Ng and colleagues have withprobabilisticnodes,thenatureofthemodelsareverydiffer-
specific
shown that sparse hierarchical Restricted Boltzmann Machines ent. It is fascinating to think about how such Bayesian
fields
(RBMs) resembles features of receptive in V1 and V2 models as the ideal observer can emerge from general learning
...
| ------------------ | --- | --- | --- | --- | --- | --- | --- | --------- | ---------- | -------- | --- | --- | --- | --- |
definition,
| Sparse | representation |     | has great | advantages. |     | By  | it  |     |     |     |     |     |     |     |
| ------ | -------------- | --- | --------- | ----------- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
’
theextremecaseofmaximalsparsenesscorrespondingtogrand- Author s Response
...
is, minimizingfree energy maximizes the probabilityof the data doi:10.1017/S0140525X12002440
...
thatthelatteristermedcomplexityreflectsour
causes.Thefact
SchoolofPhilosophy,Psychology,andLanguageSciences,Universityof
intuition that causes in the world lie in a smaller space than Edinburgh,EdinburghEH125AY,Scotland,UnitedKingdom.
| their sensory | projections. |     | Thus, | our internal |     | representation |     | andy.clark@ed.ac.uk |     |     |     |     |     |     |
| ------------- | ------------ | --- | ----- | ------------ | --- | -------------- | --- | ------------------- | --- | --- | --- | --- | --- | --- |
...
saythatthecriticismofwherethesepriorscomefrom“dissolves
|     |     |     |     |     |     |     |     | attractions | and | pitfalls of | the proposal |     | we should | keep that |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------- | --- | ----------- | ------------ | --- | --------- | --------- |
with hierarchical generative models, in which the priors them- element distinct from larger, though interlocking, issues
optimized”
selves are (Friston 2010, p. 129). This is precisely concerningthenatureofadaptiveorganizationingeneral.
whathasnotyetbeenachieved:amodelwhichlearnsasparserep-
world’s
| resentation | of sensory | messages | due | to the |     | sparseness, |     |                                               |     |     |     |     |     |     |
| ----------- | ---------- | -------- | --- | ------ | --- | ----------- | --- | --------------------------------------------- | --- | --- | --- | --- | --- | --- |
|             |            |          |     |        |     |             |     | R1. Introduction:Combiningchallengeanddelight |     |     |     |     |     |     |
ratherthanduetoitsarchitectureorstaticpriors.Ofcourse,we
...
|     |     |     |     |     |     |     |     | ated agents, | and | the future | of  | cognitive | science”–hence- |     |
| --- | --- | --- | --- | --- | --- | --- | --- | ------------ | --- | ---------- | --- | --------- | --------------- | --- |
Whatthesenativepriorsareandtheformtheytakeisaninterest-
...
fields
receptive we observe. First, there has been a strong ten- bothchallengeanddelight.Challenge,becausethevariety
dencytolearnhierarchicalmodelslayer-by-layer,witheachlayer anddepthofthecommentariesreallydemands(atleast)a
learningtoreconstructtheoutputofthepreviouswithoutbeing book-length reply, not to mention far more expertise than
...
|     |     |     |     |     |     |     |     | far richer | picture | of both | the | perils | and the | prospects of |
| --- | --- | --- | --- | --- | --- | --- | --- | ---------- | ------- | ------- | --- | ------ | ------- | ------------ |
amodelthatbalancesconformingtobothitsinputandtop-down
...
threemaintypesofchallenge(the“perils”referredtointhe
areexposedto.Thevisualcortexexperiencesastreamofimages
withsubstantialtemporalcoherenceandcorrelationwithinternal title)thatthecommentarieshaveraised.Ithenoffersome
signals such as eye movements, limiting the conclusions we can remarksonthemanyexcitingsuggestionsconcerningcomp-
draw from comparing its representation to models trained on lementary perspectives and further applications (the pro-
staticimages(see,e.g.,Rustetal.2005).
| final |     |     |     |     |     |     |     | spects).Iendbyaddressingakindofconceptualpuzzle(I |     |     |     |     |     |     |
| ----- | --- | --- | --- | --- | --- | --- | --- | ------------------------------------------------- | --- | --- | --- | --- | --- | --- |
The comment we would like to make here concerns the “the perceiver”)
|                |              |            |              |              |           |            |           | call it                                       | puzzle     | of the | porous     |       | that          | surfaced    |
| -------------- | ------------ | ---------- | ------------ | ------------ | --------- | ---------- | --------- | --------------------------------------------- | ---------- | ------ | ---------- | ----- | ------------- | ----------- |
| discussion     | of Bayesian  | processes. |              | Bayesian     | models    | such       | as the    |                                               |            |        |            |       |               |             |
|                |              |            |              |              |           |            |           | in different                                  | ways       | and    | that helps | focus | some          | fundamental |
| ideal observer | have         | received   | considerable |              | attention | in         | neuro-    |                                               |            |        |            |       |               |             |
|                |              |            |              |              |           |            |           | questions                                     | concerning |        | the nature | (and  | plausibility) | of the      |
| science        | since they   | seem       | to nicely    | capture      | human     | abilities  | to        |                                               |            |        |            |       |               |             |
|                |              |            |              |              |           |            | “correct” | impliedrelationbetweenthought,agent,andworld. |            |        |            |       |               |             |
| combine        | new evidence |            | with prior   | knowledge    |           | in the     |           |                                               |            |        |            |       |               |             |
| probabilistic  | sense.       | However,   | it           | is important |           | to realize | that      |                                               |            |        |            |       |               |             |
specific
| these Bayesian | models            | are     | very         | to       | limited         | experimental |          |            |                                      |             |        |                  |          |              |
| -------------- | ----------------- | ------- | ------------ | -------- | --------------- | ------------ | -------- | ---------- | ------------------------------------ | ----------- | ------ | ---------------- | -------- | ------------ |
| tasks, often   | with              | only a  | few possible | relevant | states,         |              | and such |            |                                      |             |        |                  |          |              |
|                |                   |         |              |          |                 |              |          | R2. Perils | ofprediction                         |             |        |                  |          |              |
| models         | do not generalize |         | well to      | changing | experimental    |              | con-     |            |                                      |             |        |                  |          |              |
| ditions.       | In contrast,      | the     | Bayesian     | model    | of              | a Boltzmann  |          |            |                                      |             |        |                  |          |              |
|                |                   |         |              |          |                 |              |          | The key    | perils                               | highlighted | by     | the commentaries |          | concern      |
| machine        | represents        | general | mechanistic  |          | implementations |              | of       |            |                                      |             |        |                  |          |              |
|                |                   |         |              |          |                 |              |          | (1) the    | proper                               | “pitch”     | of the | target           | proposal | (is it about |
| information    | processing        |         | in the       | brain    | that we         | believe      | can      |            |                                      |             |        |                  |          |              |
...
Thisbringsusback,finally,tothevexedquestionofthe
perception-likestatesfromthetop-down.Thisdouble-inno-
mind–worldrelationitself.WhereFroese&Ikegamifear
|     |     |     |     |     |     |     |     | vation, carefully | modulated | by the precision-weighting |     | of  |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------------- | --------- | -------------------------- | --- | --- |
...
| “an         |     |         |       |      |             |     |         | togetherundertheinfluenceofflexiblestructuredsymbolic |     |     |     |     |
| ----------- | --- | ------- | ----- | ---- | ----------- | --- | ------- | ----------------------------------------------------- | --- | --- | --- | --- |
| is inferred |     | fantasy | about | what | lies behind | the | veil of |                                                       |     |     |     |     |
input”?
Surely it does not. In recovering the right set of languageandanalmostobsessivedrivetoengageinshared
...
“material
guistic environment itself. This is possible because brains the use of symbolic codes (encountered as
symbols”;
like ours are sensitive statistical sponges open to deep Clark 2006a) and complex social routines
...
turesofcortex(receptivefieldorientationsandspatialfre-
|     |     |     |     |     |     |     |     | tion-driven | learning that | locks on | to interacting | distal |
| --- | --- | --- | --- | --- | --- | --- | --- | ----------- | ------------- | -------- | -------------- | ------ |
quencies), as Bridgeman very eloquently reminds us, hidden causes, we may dimly imagine (WN, sect. 3.4;
| toreflecttheactual |     |     | statisticalprofileoftheenviron- |     |     |     |     |     |     |     |     |     |
| ------------------ | --- | --- | ------------------------------- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
come Clark 2006; 2008) a virtuous spiral in which our achieved
...
|     |     |     |     |     | “as |     | itself”? |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | -------- | --- | --- | --- | --- | --- |
ception presents us with the world it is in Such pattern-presenting practices should, as Roepstorff
...
| flux, |     |     |     |     |     |     | fitting |     |     |     |     |     |
| ----- | --- | --- | --- | --- | --- | --- | ------- | --- | --- | --- | --- | --- |
we select the ways that serve our needs by PP has the potential to help bridge the gap between
...
| these issues | into            | clearer  | focus      | by asking | in     | what ways, | if  | References |     |     |     |     |
specifically
| any, the | PP framework |     | illuminates |     |     | human |     |     |     |     |     |     |
| -------- | ------------ | --- | ----------- | --- | --- | ----- | --- | --- | --- | --- | --- | --- |
...
| ----------- | ---------- | ----------- | ------- | ------- | ------------ | ------------ | ------ | -------------------------------- | --- | --- | --- | --- |
|             |            |             |         |         |              | specifically |        | responsereferences,respectively] |     |     |     |     |
| free-energy | story      | targets     | nothing |         | that         | is           |        |                                  |     |     |     |     |
| human,      | though     | (of course) | it      | aims    | to encompass | human        |        |                                  |     |     |     |     |
Abelson,R.P.(1981)Psychologicalstatusofthescriptconcept.AmericanPsychol-
| cognition. | The PP | framework |     | seeks | to highlight | a cortical |     | ogist36(7):715–29. |     |     |     |     |
| ---------- | ------ | --------- | --- | ----- | ------------ | ---------- | --- | ------------------ | --- | --- | --- | --- |
[JBH]
Adams,F.&Aizawa,K.(2001)Theboundsofcognition.PhilosophicalPsychology
| processing | strategy | that, | though | not | uniquely | human, | is  |              |       |     |     |     |
| ---------- | -------- | ----- | ------ | --- | -------- | ------ | --- | ------------ | ----- | --- | --- | --- |
|            |          |       |        |     |          |        |     | 14(1):43–64. | [aAC] |     |     |     |
plausiblyessentialtohumanintelligenceandthatprovides,
...
Thatpackagedealdelivers,atasinglestroke,understanding bimodalintegration.CurrentBiology14:257–62.
[aAC]
